...
label Kitty_Masturbate: #(Situation = Situation):
    ...
    #Second time+ initial dialog
            ...
            if KittyX.Forced: 
                ...
                $ KittyX.FaceChange("sexy", 1)
                $ Line = renpy.random.choice([__("Was it that good?"),       
                    __("Didn't get enough earlier?"),
                    __("I kinda liked the audience. . .")]) 
                ch_k "[Line]"            
            elif KittyX.Mast < 3:        
                $ KittyX.FaceChange("sexy", 1)
                ...
                $ KittyX.FaceChange("sexy", 1)
                $ KittyX.ArmPose = 2
                $ Line = renpy.random.choice([__("You really like to watch."),                 
                    __("Again?"),                 
                    __("You like to watch me."),
                    __("You want me to get myself off?")]) 
                ch_k "[Line]"
                $ Line = 0
    ...
    if Approval >= 2:                                                                                
            if KittyX.Forced:
                ...
                $ Line = renpy.random.choice([__("Huh. Ok."),                 
                    __("Couldn't hurt having you around. . ."),
                    __("Two birds with one stone. . ."),
                    __("K."), 
                    __("Sure, why not?"),
                    __("Lol, ok.")]) 
                ch_k "[Line]"
    ...
    if not KittyX.Sex and Approval:                                                  
            ...
            if KittyX.Forced: 
                ...
                $ Line = renpy.random.choice([__("Oooh, you want some of this?"),                 
                    __("So you'd like another round?"),                 
                    __("You can't stay away from this. . ."), 
                    __("You gonna make me purr?"),
                    __("You wanna slide into me?")]) 
                ch_k "[Line]"
            $ Line = 0
            ...
            menu:
                ...
                "I think you'd enjoy it as much as I would. . .":             
                        if Approval:
                            ...
                            $ KittyX.Statup("Inbt", 70, 3) 
                            $ KittyX.Statup("Inbt", 40, 2) 
                            $ Line = renpy.random.choice([__("That's. . . true. . ."),     
                                __("I suppose. . ."), 
                                __("That's. . . that's a good point. . .")]) 
                            ch_k "[Line]"
                            $ Line = 0                   
                            jump Kitty_SexPrep       
            ...
            menu:
                ...
                "You might like it. . .":             
                    if Approval:
                        ...
                        $ KittyX.Statup("Inbt", 50, 2) 
                        $ Line = renpy.random.choice([__("Well, sure, ok."),     
                            __("I suppose. . ."), 
                            __("That's. . . that's a good point. . .")]) 
                        ch_k "[Line]"
                        $ Line = 0                   
