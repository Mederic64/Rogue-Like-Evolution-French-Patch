...
label Sleepover_Morning:
        ...
        if not Party[0].Sleep and Line == __("nice"):  
                if Party[0] == RogueX:
                        $ Party[0].Blush = 1
                        ch_r "Aw, that's right sweet of ya, [RogueX.Petname]."
        ...
        if len(Party) >= 2:        
            ...
            menu:
                ...
                "You were constantly tossing around, [Party[1].Name]." if Line == __("toss"):   
                        $ Line = __("toss")
                "You were tossing around constantly too, [Party[1].Name]." if Line != "toss":   
                        $ Line = __("toss")
                                    
                "You need to learn to stick to your side, [Party[1].Name]." if Line == __("toss"):  
                        $ Line = __("turn")
                "And you need to learn to stick to your side too, [Party[1].Name]." if Line != "toss":  
                        $ Line = __("turn")
                                                                    
            if not Party[1].Sleep and Line == __("nice"):  
                    if Party[1] == RogueX:
                            $ Party[1].Blush = 1
                            ch_r "Aw, that's right sweet of ya, [RogueX.Petname]."
...
label Morningwood_Check(Girls=[0,-3],D20=0):                
        ...
        if len(Party) >= 2:
                ...
                if Girls[1] >= (D20 + 1):# 1-4
                        if Line == __("yes"): #if the first girl agreed
                                $ Line = __("double")
                        else:
                                $ Line = __("other")
                elif Girls[1] <= -1:
                ...
                if Line == __("other") and Party[0].GirlLikeCheck(Party[1]) >= 500:
...
label Sleepover_MorningWood:
        ...
        menu:
            "So, um, you want to get back to it?":
                    ...
                    elif Line == __("no") and ApprovalCheck(Party[0], 1750):
            ...
            "Were you more interested in something else?":
                    if Line != "no":
                            ...
                            if Party[0] == RogueX:
                                    ...
                                    ch_l "Yeah, I guess?"
                            $ Line = __("sex")
                    elif Line == __("no") and ApprovalCheck(Party[0], 1650):
                            #if you were a dick but she's ok
                            $ Party[0].FaceChange("bemused",1)  
                            if Party[0] == RogueX:
                            ...
                            if Party[0] == RogueX:
                                    ...
                                    ch_l "No."  
            "Sorry, sorry, please continue." if Line == __("no"):
                    if ApprovalCheck(Party[0], 1450):
                            ...
                            if Party[0] == RogueX:
                                    ...
                                    ch_l "No."  
            "Sorry, but we could do something else." if Line == __("no"):
...
label Poly_Start(Newbie=0,Round2=0,Asked=0):
        ...
        if Line == __("yn") or Line == __("mn") or Line == __("nn"):
                $ Party[0].FaceChange("angry")
        elif Line == __("yy") or Line == __("ny") or Line == __("my"):
...
label Study_Session(BO=[]):                       
            ...
            $ Player.XP += 5
            $ Trigger = 0
            $ Line = renpy.random.choice([__("you run you through some basic routines, it's fairly uneventful."), 
                    __("You study up for the mutant biology test."), 
                    __("You study for the math quiz."),
                    __("You get bored and discuss student gossip instead."),
                    __("You study for a few hours, that was fun."),
                    __("You spend the next few hours studying the lit test."),
                    __("You study for the game design course.")]) 
            "[Line]"       
            $ Line = 0
...
label Frisky_Study(Prime_Bonus=0,Second=0,Line=0,Second_Bonus=0):
            ...
            if not Line and len(Party) >= 2 and not Prime_Bonus:
                        ...
                        call Frisky_Study(1)               
                        return
            elif not Line or Line == __("strip"):    
                        pass
            elif Line == __("blow"):
                        $ Party[0].FaceChange("sly")
                        if Party[0] == KittyX:
...
label Girls_Caught(Girl=0,TotalCaught=0,Shame=0,Count=0,T_Pet=0,BO=[]):
    ...
    if Line == __("fondle thighs") or Line == __("fondle breasts") or Line == __("fondle pussy") or Line == __("hotdog") or Line == __("hand"):
        ch_x "The two of you, feeling each other up like animals!"
    elif Line == __("dildo pussy") or Line == __("dildo anal"):
        ch_x "Using those. . . devices on each other, unsanitary!"
    elif Line == __("lick pussy"):
...
label Pool_Sunbathe(Girl=0,Type=0,Mod=0):
    ...
    if Current_Time == __(__("Night")) or Current_Time == __("Evening"):
            $ Girl.FaceChange("confused")
    ...
    while True:
            ...
            if Type == "no bra" or Type == "no panties":
                    ...
                    menu:
                        ...
                        "Take it off anyway.":
                            if Line == __("sure") or (Line == __("sorry") and ApprovalCheck(Girl, 600+Mod, __("O"))):
                                    if "tan" not in Girl.RecentActions and "no tan" not in Girl.RecentActions:
            ...
            elif Line == __("sorry") and (Type == __("over") or Type == __("legs")):
...
label Breakup(Girl=0,Other=0,Anger = 0,BO=[]): 
        ...
        if Line == __("threeway") and Anger < 4: 
                ...
                if Line == __("ask ") + Other.Tag and Girl.GirlLikeCheck(Other) >= 700:
        ...
        if Line == __("bargaining") and Anger < 4: 
                $ Girl.FaceChange("sad")
...
label Cheated(Girl=0,Other=0, Resolution = 0, B = 0):  
        ...
        menu:
                ...
                "You mean with [Other.Name]?":
                        ...
                        if Girl == RogueX:
                                $ Line = __("Y'all were screwing around behind my back!")
                        elif Girl == KittyX:
                                $ Line = __("Why were you all over her like that?!")
                        elif Girl == EmmaX:
                                $ Line = __("Or didn't you notice who you were fucking?")
                        elif Girl == LauraX:                                
                                $ Line = __("I can smell her on you.")
        ...
        if Resolution >= 5 and Line == __("threeway"): #she agrees to a threeway
                        if Girl.Cheated:
                                $ Girl.Statup("Love", 90, 25) 
