...
label Prologue: 
    ...
    if "Historia" not in Player.Traits:
            python:
                Player.Name  = renpy.input(__("What is your name?"), default="Zero", length = 10)
...
label tour_parting:
    ...
    if not RogueX.Kissed:
            $ Line = __("Want to make out a little?")
    else:
            $ Line = __("Want to make out a little more?")
    menu:
        extend ""
        "Ok, See you later.":
        ...
        if Line == __("flirt"):
                ...
                while D20 <= 21:
                    menu:
                        ...
                        "Look into her eyes and smile slightly." if Line == __("flirt"): 
                                $ RogueX.FaceChange("smile")                
                                $ RogueX.Statup("Love", 200, 5)
                                ...
                                $ Line = __("handholding")
                        "Grasp her hand gently, stroking the top of it." if Line == __("handholding"):                         
                                $ RogueX.Statup("Love", 200, 5)
                                $ RogueX.FaceChange("smile")                
                        ...
                        "Keep fondling her pussy." if Line == __("fondle pussy"):
                                $ RogueX.Statup("Obed", 70, 5)
                                $ RogueX.Statup("Inbt", 60, 3)  
                        ...
                        "Start fondling her tits." if Line != "fondle breasts":
                                ...
                                if Line == __("fondle breasts"):  
                                        ...
                                        $ D20 += 7
                        "Keep fondling her tits." if Line == __("fondle breasts"):
                                $ RogueX.Statup("Obed", 70, 5)
                                $ RogueX.Statup("Inbt", 60, 2)  
