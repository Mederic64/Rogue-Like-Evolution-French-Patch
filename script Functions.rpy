...
label Round10(Options = ["none"]):    
        ...
        if Current_Time == __("Night"):
                    ...
                    if bg_current == RogueX.Home:
                            ...
                            call Wait
                            if Current_Time == __("Night") and RogueX.Loc == bg_current:               
                            ...
                            call Wait
                            if Current_Time == __("Night") and KittyX.Loc == bg_current:               
                            ...
                            call Wait
                            if Current_Time == __("Night") and EmmaX.Loc == bg_current:               
                            ...
                            call Wait
                            if Current_Time == __("Night") and LauraX.Loc == bg_current:               
...
label Girls_Schedule(Girls = [], Clothes = 1, Location = 1, LocTemp = 0):
        ...
        while Girls:
                if Girls[0] in Party and Clothes != 2 or not Location: 
                        ...
                        pass         
                elif Clothes != 2 and "sleepover" in Girls[0].Traits and Current_Time == __("Morning"):
                        #she slept over, so just forget this for now  
                        pass           
                else:                                
                        if (Current_Time == __("Morning") and Clothes and Round >= 90) or Clothes == 2:
...
label EventCalls(EGirls=[]):
    ...
    #Activates Laura meet                      
        if LauraX in ActiveGirls:
                    ...
                    if Current_Time != __("Night") and "met" in KittyX.History:
    ...
    #Activates Emma meet and class stuff                       
        if EmmaX in ActiveGirls:
                if bg_current == "bg classroom" and Current_Time == __("Evening") and Weekday < 5:
...
label Girls_Arrive(Primary = 0, Secondary = 0, GirlsNum = 0,BO=[]):
        ...
        if bg_current == "bg player":
                    ...
                    if bg_current == Primary.Home:
                                    ...
                                    elif Current_Time == __("Night") and ApprovalCheck(Primary, 1000, "LI") and ApprovalCheck(Primary, 600, "OI"):
                                    ...
                                    if Line != "stay":
                                        ...
                                        menu:
                                            ...
                                            "Are you sure I can't stay?":
                                                        ...
                                                        elif Current_Time == __("Night") and ApprovalCheck(Primary, 800, "LI") and ApprovalCheck(Primary, 400, "OI"):                                                            
                ...
                if Secondary == EmmaX and len(Present) < 2 and D20 >= 10:
                        ...
                        #Determines who sits next to you
                        if Primary == EmmaX:
                                        $ Line = __("[EmmaX.Name] walks over and stands near you")
...
label Gym_Clothes(Mode = 0, Girl = [], GirlsNum = 0, BO=[]): #checked each time you enter the Gym
        ...
        while BO: #or Mode == "exit"?
                ...
                if BO[0].Loc != "bg dangerroom" or Mode == "change" or "leaving" in BO[0].RecentActions:  
                        ...
                        if Line == __("no") or __("asked gym") in BO[0].DailyActions or __("no ask gym") in BO[0].Traits:   
                                ...
                                if GirlsNum:
                                    if BO[0] == EmmaX:
                                            $ Line = __("Do you think I should change as well?")
                                    elif BO[0] == LauraX:
                                            $ Line = __("Did you want me to change into my gym clothes?")
                                    else: 
                                            $ Line = __("Should I change too?")
                                else:
                                    if BO[0] == EmmaX:
                                            $ Line = __("Did you want me to change into my gear?")
                                    elif BO[0] == LauraX:
                                            $ Line = __("Did you want me to change into my gym clothes?")
                                    else: 
                                            $ Line = __("Would you like me to change into my gym clothes?")
...
label Set_The_Scene(Chr = 1, Entry = 0, Dress = 1, TrigReset = 1, Quiet=0,BO=[]):
        ...
        if Chr:
                ...
                if bg_current == "bg study" and Current_Time != __("Night"):   
...
label Girls_Taboo(Girl=0,Cnt= 1,Choice=0,D20=0):  #nee  Rogue_Taboo(Cnt= 1,Choice=0)
        ...
        if D20 < 10:    
                ...
                elif D20 < 3 and AloneCheck(Girl) and Current_Time != __("Night"):
