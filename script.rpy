...
#World Stats
    ...
    default Time_Options = [__("Morning"), __("Midday"), __("Evening"), __("Night")]
    default Time_Count = 2
    default Current_Time = Time_Options[(Time_Count)]     
    default Week = [__("Mon"), __("Tue"), __("Wed"), __("Thu"), __("Fri"), __("Sat"), __("Sun")]
    default Weekday = 6
...
#    default LesFlag = 0                #This is triggered if a lesbian action is occurring
    ...
    default Options = []
    default Vibration = 0
    default UI_Girl = __("Rogue")       #Used only for french translation
