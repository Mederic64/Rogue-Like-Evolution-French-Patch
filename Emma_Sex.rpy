...
label Emma_Masturbate: #(Situation = Situation):
    ...
    #Second time+ initial dialog
            ...
            if EmmaX.Forced: 
                ...
                $ EmmaX.FaceChange("sexy", 1)
                $ Line = renpy.random.choice([__("I was that good?"),       
                    __("Didn't get enough earlier?"),
                    __("I did enjoy the audience participation. . .")]) 
                ch_e "[Line]"            
            elif EmmaX.Mast < 3:        
                $ EmmaX.FaceChange("sexy", 1)
                ...
                $ EmmaX.FaceChange("sexy", 1)
                $ EmmaX.ArmPose = 2
                $ Line = renpy.random.choice([__("You really do like to watch."),                 
                    __("Once more?"),                 
                    __("You enjoy watching me."),
                    __("You want me to take care of myself?")]) 
                ch_e "[Line]"
                $ Line = 0
    ...
    if Approval >= 2:                                                                                
            if EmmaX.Forced:
                ...
                $ Line = renpy.random.choice([__("Ok."),                 
                    __("It couldn't hurt having you around. . ."),
                    __("Very well."), 
                    __("Sure, why not?"),
                    __("[[chuckles]. . . ok.")]) 
                ch_e "[Line]"
                        ...
                        if "unsatisfied" in EmmaX.RecentActions:#And [EmmaX.Name] is unsatisfied,  
                            ...
                            menu:
                                ...
                                "Yes, keep going for a bit.":
                                    $ Line = __("You let her get back into it")
                                    jump Emma_M_Cycle  
                                "No, I'm done.":
                                    "You ask her to stop."
                                    return 
...
label Emma_Sex_P:  
    ...
    if not EmmaX.Sex and Approval:                                                  
            ...
            if EmmaX.Forced: 
                ...
                $ Line = renpy.random.choice([__("Back again?"),                 
                    __("You'd like another round?"),                 
                    __("I suppose I am irresistible. . ."), 
                    __("Didn't get enough earlier?"),
                    __("You're wearing me out, ") + EmmaX.Petname + __(".")]) 
                ch_e "[Line]"
            elif EmmaX.Sex < 3:        
                $ EmmaX.Brows = "confused"
                $ EmmaX.Mouth = "kiss"
                ...
                $ Line = renpy.random.choice([__("Oh, you want some of this?"),                 
                    __("You'd like another round?"),                 
                    __("I suppose I am irresistible. . ."), 
                    __("Do you intend to make me melt?"),
                    __("You want me to ride you?")]) 
                ch_e "[Line]"
            $ Line = 0
    ...
    if Approval >= 2:                                                                  
            ...
            if EmmaX.Forced:
                ...
                $ EmmaX.Statup("Love", 90, 1)
                $ EmmaX.Statup("Inbt", 50, 3) 
                $ Line = renpy.random.choice([__("Well. . . fine, I accept."),                 
                    __("Sure!"), 
                    __("We could, I suppose."),
                    __("Hmmm, yes."),
                    __("How could I refuse?")]) 
                ch_e "[Line]"
                $ Line = 0
            $ EmmaX.Statup("Obed", 20, 1)
            $ EmmaX.Statup("Obed", 60, 1)
            ...
            menu:
                ...
                "I think you'd enjoy it as much as I would. . .":             
                        if Approval:
                            ...
                            $ EmmaX.Statup("Inbt", 70, 3) 
                            $ EmmaX.Statup("Inbt", 40, 2) 
                            $ Line = renpy.random.choice([__("I can't exactly argue with that. . ."),     
                                __("I suppose. . ."), 
                                __("You raise a good point. . .")]) 
                            ch_e "[Line]"
                            $ Line = 0                   
                            jump Emma_SexPrep       
        ...
        if Player.Focus >= 100 or EmmaX.Lust >= 100:   
                    ...
                    if Line == __("came"): #ex Player.Focus <= 20: 
                            ...
                            if not Player.Semen:
                                ...
                                $ Line = renpy.random.choice([__("She continues to shake a little with pleasure."), 
                                    __("She is breathing heavily as your cock rubs inside her."), 
                                    __("She slowly turns back towards you and smiles."),
                                    __("She doesn't seem ready to stop.")])
                                "[Line] Keep going?"
                                menu:
                                    extend ""
    ...
    if not EmmaX.Anal and Approval:                                                 
            ...
            if EmmaX.Forced: 
                ...
                $ Line = renpy.random.choice([__("Back again so soon?"),                 
                    __("So you'd like another round?"),                 
                    __("I'm still a little sore from earlier."), 
                    __("Didn't get enough earlier?"),
                    __("You're wearing me out, ") + EmmaX.Petname + __(".")]) 
                ch_e "[Line]"    
            else:       
                $ EmmaX.FaceChange("sexy", 1)
                $ EmmaX.ArmPose = 2
                $ Line = renpy.random.choice([__("Oooh, you want some of this?"),                 
                    __("So you'd like another round?"),                 
                    __("I knew you enjoyed it. . ."), 
                    __("Do you intend to make me melt?"),
                    __("You want me to ride you?")]) 
                ch_e "[Line]"
            $ Line = 0
...
label Emma_Sex_H: 
    ...
    if not EmmaX.Hotdog and Approval:                                                
            ...
            if EmmaX.Forced: 
                ...
                $ Line = renpy.random.choice([__("Back again so soon?"),                 
                    __("So you'd like another round?"),                 
                    __("You're really into this. . ."), 
                    __("Are you sure that's all you want?")]) 
                ch_e "[Line]"    
            else:       
                $ EmmaX.FaceChange("sexy", 1)
                $ EmmaX.ArmPose = 2
    ...
    if Approval >= 2:                                                                  
            ...
            if EmmaX.Forced:
                ...
                $ EmmaX.Statup("Love", 80, 1)
                $ EmmaX.Statup("Inbt", 50, 2) 
                $ Line = renpy.random.choice([__("Well, sure, let me give it a rub."),                 
                    __("Very well."),                 
                    __("Nice!"), 
                    __("I suppose we could do that."),
                    __("Allow me. . ."),
                    __("Heh, ok, ok.")]) 
                ch_e "[Line]"
                $ Line = 0
