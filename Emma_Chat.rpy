...
# Emma Sexchat / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /
label Emma_SexChat:
    $ Line = __("Hmm? What did you want to talk about?") if not Line else Line
    while True:
            menu:
                ch_e "[Line]"                
                ...
                "Never Mind" if Line == __("Hmm? What did you want to talk about?"):
                        return
                "That's all." if Line != "Hmm? What did you want to talk about?":
                        return
            if Line == __("Yeah, what did you want to talk about?"):
    ...
    if Options[0] == "mandrill":                             
        ...
        ch_e ". . . I may have some. . . purpose for you later. . ."
            ...
            if "blow" not in EmmaX.Chat:
                    ...
                    $ Line = renpy.random.choice([__("You've a taste that's easy to acquire."), 
                            __("My jaw is a bit sore lately."), 
                            __("If you need some. . . attention, let me know."),
                            __("Mmmm. . . [she mimes her tongue knocking against her cheek.]")])
                    ch_e "[Line]"
        ...
        $ Line = renpy.random.choice([__("I'd rather keep this professional."), 
                __("If you have something to say, put it in writing."), 
                __("Back off."),
                __("Leave me alone.")])
        ch_e "[Line]"
