...
label Kitty_Love_End:    
    if Line == __("awkward") or __("lover") not in KittyX.Petnames:
            hide Kitty_Sprite with easeoutright
            call Remove_Girl(KittyX)
            return
