...
label Girl_Tag(Girl=0,Forced = 0,Gloves=0):
        ...
        if Forced and Player.Lvl >= 5:
            ...
            menu:
                ...
                if Gloves == "gloves":
                        $ Girl.Arms = 0
                        $ Line = __("She pulls off her gloves and")
                else:
                        $ Line = __("She reaches out and")
                if Girl == RogueX:
...
label KissPrep(Girl=Ch_Focus):    
        ...
        if Girl.Kissed >= 10 and Girl.Lust >= 80:
                $ Line = renpy.random.choice([__("She's all over you, running her hands along your body."),  
                        __("She's all over you, licking all over your face and neck."),  
                        __("She's all over you, kissing all over your face and grinding against you.")])   
        elif Girl.Kissed > 7:
                $ Line = renpy.random.choice([__("She's really sucking face."),
                        __("You kiss deeply and passionately."),
                        __("You kiss deeply and passionately."),
                        __("You kiss deeply and passionately.")]) 
        elif Girl.Kissed > 3:
                $ Line = renpy.random.choice([__("She's really getting into it."),
                        __("She's really getting into it, her tongue's going at it."),
                        __("She's really getting into it, there's some heavy tongue action.")]) 
        else:
                $ Line = __("You and "+ Girl.Name +" make out for a while.")
        "[Line]"    
        $ Cnt = 0
        $ Trigger = "kiss you"
        $ Line = 0
        ...
        while Round >= 10 and MCount < 10:  
                ...
                if Current == "neck":            
                        ...
                        if Past in ("shoulders","back"):
                                $ Line = __("You slide your hands toward ") +Girl.Name+ "'s " +Current
                                $ Check = 400
                        else:
                                $ Line = __("You begin to massage ") +Girl.Name+ "'s " +Current
                                $ Check = 500
                        ...
                        if Girl.MassageChart[MCount] == Current and ApprovalCheck(Girl, Check):
                                ...
                                $ Check = 600
                                $ Line = __("You continue to massage ") +Girl.Name+ "'s " +Current
                        #end shoulders   
                        if not Girl.Over:
                                $ Girl.Addict -= 2                 
                elif Current == "back":
                        ...
                        call expression Girl.Tag + "_Breasts_Launch" pass (0)
                        if Past == "back":
                                $ Line = __("You slide your hands around and grasp ") +Girl.Name+ "'s " +Current
                                $ Check = 1000
                        else:
                                $ Line = __("You move your hands to grab ") +Girl.Name+ "'s " +Current
                                $ Check = 1050
                        ...
                        if Girl.MassageChart[MCount] == Current and ApprovalCheck(Girl, Check):
                                ...
                                $ Check = 1050
                                $ Girl.Statup("Lust", 200, 2)
                                $ Line = __("You continue to rub ") +Girl.Name+ "'s " +Current
                        #end breasts
                        ...
                        call expression Girl.Tag + "_Breasts_Launch" pass (0)
                        if Past == "shoulders":
                                $ Line = __("You slide your hands down ") +Girl.Name+ "'s " +Current
                                $ Check = 400
                        elif Past == "hands":
                                $ Line = __("You slide your hands up ") +Girl.Name+ "'s " +Current
                                $ Check = 400
                        else:
                                $ Line = __("You begin to massage ") +Girl.Name+ "'s " +Current
                                $ Check = 500
                        ...
                        call expression Girl.Tag + "_Breasts_Launch" pass (0) 
                        if Past == "arms":
                                $ Line = __("You slide your hands down and grasp ") +Girl.Name+ "'s " +Current
                                $ Check = 400
                        else:
                                $ Line = __("You pick up " +Girl.Name+ "'s " +Current+ " and begin to massage them")
                                $ Check = 500
                        ...
                        if Past == "back":
                                $ Line = __("You slide your hands down toward ") +Girl.Name+ "'s " +Current
                                $ Check = 400
                        elif Past in ("ass","pussy","thighs"):
                                $ Line = __("You slide your hands up toward ") +Girl.Name+ "'s " +Current
                                $ Check = 400
                        else:
                                $ Line = __("You begin to massage ") +Girl.Name+ "'s " +Current
                                $ Check = 500
                        ...
                        if Past in ("back","hips"):
                                ...
                                $ Line = __("You slide your hands up to ") +Girl.Name+ "'s " +Current
                                $ Check = 900
                        else:
                                $ Line = __("You begin to massage ") +Girl.Name+ "'s " +Current
                                $ Check = 950
                        ...
                        call expression Girl.Tag + "_Pussy_Launch" pass (0)
                        if Past in ("hips","ass"):
                                $ Line = __("You slide your hands around toward ") +Girl.Name+ "'s " +Current
                                $ Check = 1200
                        elif Past == "thighs":
                                $ Line = __("You slide your hands up and into " +Girl.Name+ "'s groin")
                                $ Check = 1100
                        else:
                                $ Line = __("You begin to massage ") +Girl.Name+ "'s " +Current
                                $ Check = 1200
                        ...
                        if Past == "feet":
                                $ Line = __("You slide your hands up and stroke ") +Girl.Name+ "'s " +Current
                                $ Check = 400
                        elif Past == "thighs":
                                $ Line = __("You slide your hands up to grab ") +Girl.Name+ "'s " +Current
                                $ Check = 400
                        else:
                                $ Line = __("You begin to massage ") +Girl.Name+ "'s " +Current
                                $ Check = 500
                        ...
                        if Past == "calves":
                                ...
                                $ Line = __("You begin to rub ") +Girl.Name+ "'s " +Current
                                $ Check = 600
                ...
                if Girl.MassageChart[MCount] == Current and ApprovalCheck(Girl, Check):
                        ...
                        #kinda likes it
                        $ Line = Line + renpy.random.choice([__(". She wriggles a little in contentment."), 
                                __(". She lets out a little hum."),
                                __(". She really seems to enjoy it."),
                                __(". She seems comfortable with this."),
                                __(". She lets out a small purr of pleasure.")])  
                        $ Girl.Statup("Lust", 60, 2)
                        $ Girl.Statup("Lust", 90, 1)
                        "[Line]"
                        ...
                        # dislikes it                            
                        $ Line = Line + renpy.random.choice([__(". She stiffens a bit, but settles back into it."), 
                                __(". She doesn't seem to enjoy it."),
                                __(". She doesn't seem comfortable with this."),
                                __(". She lets out a small tsk of irritation.")]) 
                        $ Girl.Statup("Lust", 60, -1)
                        $ Girl.Statup("Lust", 90, -2)
                        "[Line]"            
                        if Current == Past and Current in ("breasts","ass","pussy"):
...
label Group_Strip(Girl=0,Tempmod = Tempmod,TempmodP=[0,0],BO=[]): #@nee Tempmod0=0,Tempmod1=0
    ...
    #            $ Present.remove(Present[2])
        ...
        if "stripping" in Present[0].DailyActions and ApprovalCheck(Present[0], 500, TabM = 3):
                $ Line = renpy.random.choice([__("You liked the show earlier?"),       
                    __("Didn't get enough earlier?"),
                    __("You're going to wear me out.")]) 
        else:
                $ Line = renpy.random.choice([__("Ok, that sounds fun."),       
                    __("I could get into that."),
                    __("Yeah, ok.")]) 
        ...
        if not Girl.LesWatch and Approval:   
                ...
                #End first time with approval dialogs    
                    ...
                    if Girl.Forced: 
                            ...
                            $ Girl.FaceChange("sexy", 1)
                            $ Line = renpy.random.choice([__("Enjoyed the show?"),       
                                    __("Didn't get enough earlier?"),
                                    __("I don't mind having an audience. . .")]) 
                            ...
                            $ Girl.FaceChange("sexy", 1)
                            $ Girl.ArmPose = 2
                            $ Line = renpy.random.choice([__("You do like to watch."),                 
                                    __("So you'd like us to go again?"),                 
                                    __("You want to watch some more?"),
                                    __("You want me to get it on with ")+Partner.Tag+__("?")]) 
                            call AnyLine(Girl,Line)  
                    $ Line = 0                        
        ...
        if Approval >= 2:      
                    ...
                    if Girl.Forced:
                            ...
                            if Situation == "interrupted":
                                    ...
                                    $ Line = renpy.random.choice([__("Well. . . ok."),                 
                                        __("I don't mind getting with her. . ."),
                                        __("A"),    
                                        __("Sure."), 
                                        __("I guess. . ."),
                                        __("Heh, ok, fine.")]) 
...
label Les_FirstKiss:
        ...
        if "les " + Partner.Tag in Girl.History:
                ...
                $ Line = __("first partner")
                   
        if Line == __("experienced"):
...
label Les_Change(Primary = 0, Secondary=Partner, D20S=0, PrimaryLust=0, SecondaryLust=0): #nee (D20S=0, Secondary=Partner, Primary = "Rogue", PrimaryLust=0, SecondaryLust=0):
        ...
        menu:
            ...
            "never mind.":
                pass
        if not Line:
            $ Line = __("You return to what you were doing.")
        else:
            $ Situation = "skip"
        "[Line]"
        return
