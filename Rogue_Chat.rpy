...
label Rogue_Chitchat(O=0, Options = ["default","default","default"]):   
    ...
    if Options[0] == "virgin": # "virgin line" not yet triggered:
        ...
        $ Line = renpy.random.choice([__("You know, you taste better than I thought."), 
                __("You're making my jaw a bit sore there."), 
                __("Let me know if you want a little mouth attention."),
        ...
        $ Line = renpy.random.choice([__("Get away from me."), 
                __("I don't want to see your face."), 
                __("Stop bothering me."),
                __("Leave me alone.")])
        ch_r "[Line]"
