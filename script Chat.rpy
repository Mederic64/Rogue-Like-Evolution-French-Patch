...
#                "Say you love her":
#                            call Love_You(Girl)
                "Phone Sex" if bg_current == "bg player":
                        ...
                        return
                "Phone Sex [[not here] (locked)" if bg_current != "bg player":
                        pass
                "Never mind [[exit]":
                        pass
    else:
            ...
            menu:        
                ...
                "Kiss her lips":
                            if ApprovalCheck(Girl, 1000, TabM=2,Alt=[[RogueX],800]) or ApprovalCheck(Girl, 600, "L", TabM=2): 
                                    $ Line = renpy.random.choice([__("You lean over, put your hand against her cheek, and plant a kiss on her lips."),      
                                                                    __("You lean down, tilt her head back, and plant a kiss on her lips."),
                                                                    __("You turn ")+Girl.Name+__(" around and plant a deep kiss on her.")]) 
                                    "[Line]"
