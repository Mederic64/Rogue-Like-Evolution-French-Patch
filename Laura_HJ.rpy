    ...
    if not LauraX.Hand and Approval:                                                 #First time dialog        
        ...
        if LauraX.Forced: 
            ...
            $ Line = renpy.random.choice([__("Another one?"),   
                __("I'm glad I don't grow calluses."), 
                __("Didn't get enough earlier?"),
                __("Again the with handjobs, huh?"),
                __("I guess you want more.")]) 
            ch_l "[Line]"
        elif LauraX.Hand < 3:        
            $ LauraX.FaceChange("sexy", 1)
            ...
            $ LauraX.FaceChange("sexy", 1)
            $ LauraX.ArmPose = 2
            $ Line = renpy.random.choice([__("You want some more?"),                 
                __("So you'd like another handy?"),                 
                __("You want a. . . [fist pumping hand gestures]?"), 
                "Another handjob?"]) 
            ch_l "[Line]"
        $ Line = 0
...
label Laura_Titjob:
    ...
    if not LauraX.Tit and Approval:                                                 #First time dialog    
        ...
        if LauraX.Forced: 
            ...
            $ LauraX.FaceChange("sexy", 1)
            $ Line = renpy.random.choice([__("Back for more?"),   
                __("You're really working these puppies."), 
                __("Didn't get enough earlier?"),  
                __("You're really working these puppies.")]) 
            ch_l "[Line]"
        elif LauraX.Tit < 3:        
...
label Laura_Blowjob:
    ...
    if not LauraX.Blow and Approval:                                                 #First time dialog        
        ...
        if LauraX.Forced: 
            ...
            $ Line = renpy.random.choice([__("Back again so soon?"),   
                __("Wear'in me out here."),  
                __("I must be too good at this."), 
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        if LauraX.Forced:
            ...
            $ LauraX.Statup("Love", 90, 1)
            $ LauraX.Statup("Inbt", 50, 3) 
            $ Line = renpy.random.choice([__("Sure. Ahhhhhh."),                 
                __("Well. . . alright."),                 
                __("Yum."), 
                __("Sure, whip it out."),
