...
label Rogue_Fondle_Breasts:
    ...
    if "fondle breasts" in RogueX.RecentActions:
        ...
        $ RogueX.FaceChange("sexy", 1)
        $ Line = renpy.random.choice([__("Didn't get enough earlier?"),
            __("Maybe not so hard this time though."),
            __("Mmm. . .")]) 
        ch_r "[Line]"
...
label Rogue_Fondle_Pussy:
    ...
    if Situation == "pullback":     
        ...
        $ Line = renpy.random.choice([__("Didn't get enough earlier?"),
            __("Maybe not so hard this time though."),
            __("Take it a bit gently, I'm still quivering from earlier."),
            __("Mmm. . .")]) 
        ch_r "[Line]"
...
label Rogue_Lick_Pussy: 
    ...
    if "lick pussy" in RogueX.RecentActions:
        ...
        $ RogueX.FaceChange("sexy", 1)
        $ Line = renpy.random.choice([__("Didn't get enough earlier?"),
            __("Again? Oh, you're insatiable!"),
            __("Must be my lucky day!"),
            __("You sure know how to keep a girl satisfied. . ."),
            __("Mmm. . .")]) 
        ch_r "[Line]"
...
label Rogue_Fondle_Ass: 
    ...
    if Situation == "pullback":     
        ...
        $ RogueX.FaceChange("sexy", 1)
        $ Line = renpy.random.choice([__("Didn't get enough earlier?"),
            __("Maybe not so rough this time though."),
            __("Mmm. . .")]) 
        ch_r "[Line]"
...
label Rogue_Lick_Ass: 
    ...
    if "lick ass" in RogueX.RecentActions:
        ...
        $ RogueX.FaceChange("sexy", 1)
        $ Line = renpy.random.choice([__("Didn't get enough earlier?"),
            __("I'm still tingling a bit from earlier."),
            __("Mmm. . .")]) 
        ch_r "[Line]"
