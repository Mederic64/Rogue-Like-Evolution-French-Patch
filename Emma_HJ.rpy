...
label Emma_Handjob:
    ...
    if not EmmaX.Hand and Approval:                                                 #First time dialog        
        ...
        if EmmaX.Forced: 
            ...
            $ EmmaX.FaceChange("sexy", 1)
            $ Line = renpy.random.choice([__("Another?"),   
                __("You're going to wear out my arm."), 
                __("Didn't get enough earlier?"),
                __("My hand's a bit sore from earlier."),
                __("My hand's rather sore from before.")]) 
            ch_e "[Line]"
        elif EmmaX.Hand < 3:        
            ...
            $ EmmaX.FaceChange("sexy", 1)
            $ EmmaX.ArmPose = 2
            $ Line = renpy.random.choice([__("You want more?"),                 
                __("So you'd like another?"),                 
                __("More of this? [fist pumping hand gestures]"), 
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        if EmmaX.Forced:
            ...
            $ Line = renpy.random.choice([__("Oh, I suppose."),                 
                __("I'll do it."),                 
                __("Well, give it here."), 
                __("I suppose I could. . ."),
                __("Fine. . . [She gestures for you to come over]."),
                "Ok, ok."]) 
            ch_e "[Line]"
            $ Line = 0
...
label Emma_HJ_Cycle:    
    while Round >=0:  
        ...
        if Player.Focus >= 100 or EmmaX.Lust >= 100: 
                    ...
                    if Line == __("came"): #ex Player.Focus <= 20: 
                            #If you've just cum,  
                            $ Line = 0
                            if not Player.Semen:
...
label Emma_Titjob:
    ...
    if not EmmaX.Tit and Approval:                                                
        ...
        if EmmaX.Forced: 
            ...
            $ EmmaX.FaceChange("sexy", 1)
            $ Line = renpy.random.choice([__("Back again so soon?"),   
                __("You're going to wear them out."), 
                __("Didn't get enough earlier?"),
                __("I'm still a bit sore from earlier.")]) 
            ch_e "[Line]"
        elif EmmaX.Tit < 3:        
            $ EmmaX.FaceChange("sly", 1)
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        if EmmaX.Forced:
            ...
            $ EmmaX.Statup("Love", 90, 1)
            $ EmmaX.Statup("Inbt", 50, 3) 
            $ Line = renpy.random.choice([__("Well, sure, come over here."),                 
                __("Oh, very well."),                 
                __("Mmmmm."), 
                __("Fine, whip it out."),
                __("Fine. . . [She drools a bit into her cleavage]."),
                "Oh, all right."]) 
            ch_e "[Line]"
            $ Line = 0
        $ EmmaX.Statup("Obed", 20, 1) 
                    ...
                    if Approval:       
                        ...
                        menu:
                            ...
                            "Sure, that's fine.":
                                ...
                                $ EmmaX.Statup("Obed", 50, 1) 
                                jump Emma_HJ_Prep
                            "Seriously, titties." if Line == __("no BJ"):  
                                $ Line = 0
...
label Emma_Blowjob:
    ...
    if not EmmaX.Blow and Approval:                                                 #First time dialog        
        ...
        if EmmaX.Forced: 
            ...
            $ EmmaX.FaceChange("sexy", 1)
            $ Line = renpy.random.choice([__("Back so soon?"),   
                __("Let me get some saliva going."),
                __("Didn't get enough earlier?"),
                __("My jaw's still sore from our prior engagement."),
                __("My jaw's still a bit sore from earlier.")]) 
            ch_e "[Line]"
        elif EmmaX.Blow < 3:        
            $ EmmaX.FaceChange("sexy", 1)
            $ EmmaX.Brows = "confused"
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        if EmmaX.Forced:
            ...
            $ Line = renpy.random.choice([__("Well, ok."),                 
                __("Well. . . ok."),                 
                __("Mmmm."), 
                __("Sure, let me have it."),
                __("Mmmm. . . [She licks her lips]."),
                "Ok, fine."]) 
            ch_e "[Line]"
            $ Line = 0
        $ EmmaX.Statup("Obed", 20, 1) 
        ...
        menu:
            ...
            "Come on, please?":             
                if Approval:
                    ...
                    $ EmmaX.Statup("Inbt", 70, 3) 
                    $ EmmaX.Statup("Inbt", 40, 2) 
                    $ Line = renpy.random.choice([__("Well, I suppose."),                 
                        __("Well. . . ok."),                 
                        __("I could perhaps give it a try."), 
                        __("I suppose I could. . ."),
                        __("Fine. . . [She licks her lips]."),
                        "Hmph, ok, fine."]) 
                    ch_e "[Line]"
                    $ Line = 0                   
                    jump Emma_BJ_Prep
...
label Emma_Dildo_Pussy:
    ...
    if not EmmaX.DildoP and Approval:                                                 
            ...
            if EmmaX.Forced: 
                ...
                $ EmmaX.FaceChange("sexy", 1)
                $ Line = renpy.random.choice([__("Breaking out the toys again?"),       
                    __("Didn't get enough earlier?"),
                ...
                $ EmmaX.FaceChange("sexy", 1)
                $ EmmaX.ArmPose = 2
                $ Line = renpy.random.choice([__("You want some of this action?"),                 
                    __("So you'd like another go?"),                 
                    __("You want to stick it in my pussy again?"),
                    __("You want me ta lube up your toy?")]) 
                ch_e "[Line]"
                $ Line = 0
    ...
    if Approval >= 2:                                                                   
            ...
            if EmmaX.Forced:
                ...
                $ EmmaX.Statup("Love", 90, 1)
                $ EmmaX.Statup("Inbt", 50, 3) 
                $ Line = renpy.random.choice([__("Well, sure, stick it in."),                 
                    __("Well. . . ok."),                 
                    __("Sure!"), 
                    __("I guess I could. . . stick it in."),
                    __("Delightful."),
                    __("Hmm, ok, ok.")]) 
                ch_e "[Line]"
                $ Line = 0
            ...
            menu:
                ...
                "I think you'd like it. . .":             
                    if Approval:
                        ...
                        $ Line = renpy.random.choice([__("Well, sure, stick it in."),     
                            __("I suppose. . ."), 
                            __("You make a compelling argument.")]) 
                        ch_e "[Line]"
                        $ Line = 0                   
                        jump Emma_DP_Prep
                    else:   
...
label Emma_Dildo_Ass:
    ...
    if not EmmaX.DildoA and Approval:                                                 
            ...
            if EmmaX.Forced: 
                ...
                $ Line = renpy.random.choice([__("You want some of this action?"),                 
                    __("So you'd like another go?"),                 
                    __("You'd like to stick it in my ass again?"),
                    __("You'd like me to lube up your toy?")]) 
                ch_e "[Line]"
                $ Line = 0
            ...
            menu:
                ...
                "I think you'd like it. . .":             
                    if Approval:
                        ...
                        $ EmmaX.Statup("Inbt", 70, 3) 
                        $ EmmaX.Statup("Inbt", 40, 2) 
                        $ Line = renpy.random.choice([__("Very well, stick it in."),     
                            __("I suppose. . ."), 
                            __("You make a compelling argument.")]) 
                        ch_e "[Line]"
                        $ Line = 0                   
...
label Emma_Footjob:
    ...
    if not EmmaX.Foot and Approval:                                                 #First time dialog        
        ...
        if EmmaX.Forced: 
            ...
            $ EmmaX.FaceChange("sexy", 1)
            $ Line = renpy.random.choice([__("Another?"),   
                __("I'd rather not get calluses."), 
                __("Didn't get enough earlier?"),
                __("My feet are rather sore from earlier."),
                __("My feet are rather sore from earlier.")]) 
            ch_e "[Line]"
        elif EmmaX.Foot < 3:        
            $ EmmaX.FaceChange("sexy", 1)
            ...
            $ EmmaX.FaceChange("sexy", 1)
            $ EmmaX.ArmPose = 2
            $ Line = renpy.random.choice([__("You'd like me to use my feet again?"),                 
                __("So you'd like another footjob?"),                 
                __("Mmmm, some. . . [she rubs her foot along your leg]?"), 
                "A little foot rub?"]) 
            ch_e "[Line]"
        $ Line = 0
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        if EmmaX.Forced:
            ...
            $ EmmaX.Statup("Love", 90, 1)
            $ EmmaX.Statup("Inbt", 50, 3) 
            $ Line = renpy.random.choice([__("Sure, I suppose."),                 
                __("Fine."),                 
                __("Very well, bring it out."), 
                __("I suppose I could. . ."),
                __("Fine. . . [She gestures for you to come over]."),
                "Hmm, ok."]) 
            ch_e "[Line]"
