...
# Laura Sexchat <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
label Laura_SexChat:
    $ Line = __("Yeah, what did you want to talk about?") if not Line else Line
    while True:
            menu:
                ch_l "[Line]"                
                ...
                "Never Mind" if Line == __("Yeah, what did you want to talk about?"):
                        return
...
#            $ LauraX.Chat.append("cheek") 
            ...
            if "blow" not in LauraX.Chat:
                    ...
                    $ Line = renpy.random.choice([__("I gotta tell you, your dick tastes great."), 
                            __("I think I nearly dislocated my jaw last time."), 
                            __("Let me know if you'd like another blowjob sometime."),
                            __("Hmmm. . . [she mimes her tongue knocking against her cheek.]")])
                    ch_l "[Line]"
...
#        call Laura_Daddy  
        ...
        $ Line = renpy.random.choice([__("Get away from me."), 
                __("I don't want to smell you near me."), 
                __("Back off."),
                __("Buzz off.")])
        ch_l "[Line]"
