...
image setting = LiveComposite(
    (1024,768),
    (0, 0), ConditionSwitch(        
        "Current_Time == __('Evening')", "images/sky_sunset.jpg",
        "Current_Time == __('Night')", "images/sky_night.jpg",        
...
#        "bg_current == 'bg classroom'", "images/ClassroomLit.jpg",        
        ...
        "Current_Time == __('Evening')",    "images/Crossroads_Evening.jpg",
        "Current_Time == __('Night')",      "images/Crossroads_Night.jpg",    
...
image bg_campus:
        contains: #see if this works, if not remove it
            ConditionSwitch(
                "Current_Time == __('Evening')",    "images/Campus_Evening.png",
                "Current_Time == __('Night')",      "images/Campus_Night.png",    
...
image bg_pool:
        contains: #see if this works, if not remove it
            ConditionSwitch(
                "Current_Time == __('Evening')",    "images/pool_evening.png",
                "Current_Time == __('Night')",      "images/pool_night.png",    
...
image bg_class:
        ...
        contains:
            ConditionSwitch(        
                "bg_current != 'bg classroom' or Current_Time == __('Evening') or Current_Time == __('Night') or Weekday >= 5", Null(),
...
image bg_study:
        contains: #see if this works, if not remove it
            ConditionSwitch(
                "Current_Time == __('Night')",      "images/StudyNight.jpg",    
...
label Rogue_TJ_Launch(Line = 0):  
    ...
    if not RogueX.Tit and Line == __("L"): #first time
