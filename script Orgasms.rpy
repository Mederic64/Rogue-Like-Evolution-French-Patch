...
# intro lines    
    if Trigger == "hand":
            $ Line = __("As she strokes, you're about ready to come. . .")
    elif Trigger == "blow":
            $ Line = __("As she sucks at you, you start to feel about to come. . .")
    elif Trigger == "titjob":
            $ Line = __("As you rub into her cleavage, you start to feel about to come. . .")
    elif Trigger == "sex" or Trigger == "anal":
            $ Line = __("As you thrust into her, you feel about to blow. . .")
    elif Trigger == "hotdog":
            $ Line = __("As you grind into her, you feel about to blow. . .")
    else:        
            $ Line = __("You start to feel about to come. . .")
...
label Girl_Cumming(Girl=0,Quick=0,BO=[]): #rename from Girl_Cumming
    ...
    $ Girl.Mouth = "tongue"
    if Girl == RogueX:
            $ Line = renpy.random.choice([__("Wow. . .  just, wow."), 
                __("I don't know what came over me. . ."), 
                __("Hmmmm. . . ."),
                __("That, felt good. Thatfeltrealgood.")])
    elif Girl == KittyX:
            $ Line = renpy.random.choice([__("Wow. . .  just, wow."), 
                __("That was amazing!"), 
                __("Hmmmm. . . ."),
            ...
            $ Line = renpy.random.choice([__("Oooooh. . . lovely."), 
                __("I really enjoyed that one. . ."), 
                __("Hmmmm. . . ."),
                __("That was. . . greaaaaat. . .")])#e
    elif Girl == LauraX:
            $ Line = renpy.random.choice([__("Oooooh. . ."), 
                __("That was a good one. . ."), 
                __("Hmmmm. . . ."),
                __("That was. . .")]) #L
