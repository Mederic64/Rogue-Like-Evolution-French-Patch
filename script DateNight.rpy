label Date_Ask(Girl=0):
        ...
        menu:
            "Good, I'll meet you in the campus square." if bg_current != "bg campus" or Current_Time != __("Evening"): 
                            $ Girl.FaceChange("smile")
            "Good, let's get going then." if bg_current == "bg campus" and Current_Time == __("Evening"): 
                            $ Girl.FaceChange("smile")
        ...
        if bg_current != "bg campus" or Current_Time != __("Evening"): 
                if Girl == RogueX:      
...
label Player_Dinner:
    ...
    menu:
        ...
        "Surf and turf. ($20)":
            $ Play_Cost = 20
            $ Line = __("steak and a juicy lobster")
        "Steak. ($15)":  
            $ Play_Cost = 15
            $ Line = __("medium rare ribeye")
        "Chicken. ($10)":
            $ Play_Cost = 10
            $ Line = __("pangrilled chicken thighs")
        "Just a salad. ($5)":
            $ Play_Cost = 5
            $ Line = __("fresh garden salad")
    return
...
#                    call Date_Bonus(LauraX,0)   
    ...
    if "romcom" in Player.RecentActions:    
        $ Line = renpy.random.choice([__("You watch the movie, which is about an adorkable girl who can't choose between two hunky guys. She picks the other one."), 
                    __("You watch the movie, which is about a girl who is mercilessly stalked by some weird guy, until she eventually decides she loves him. They live hapily ever after."), 
                    __("In this movie, the lead goes to all her friend's weddings, but can't get it together herself. She dies alone. Just kidding, she gets married at the end."), 
                    __("You watch the movie, in which a bunch of college girls go on a wild adventure and have lots of random sex."),
                    __("This movie is about a girl who's convinced to live in a sex dungeon, and really seems to enjoy it."),
                    __("This movie is about a girl who works for a fashion house and is bullied by her boss, until they become friends.")])        
    elif "action" in Player.RecentActions: 
        $ Line = renpy.random.choice([__("You watch the movie, which is about an ex marine fighting aliens."), 
                    __("You watch the movie, which is about a girl who is mercilessly stalked by some weird guy, until she eventually decides she loves him. They live hapily ever after. There are also a lot of explosions."), 
                    __("In this movie, giant robots are fighting animal mash-ups, with the fate of the world in the balance."), 
                    __("You watch the movie, in which a team of non-mutant superhumans are apparently fighting some sort of silvery robots in Eastern Europe."),
                    __("This movie is about a superhuman powerhouse that nearly wrecks a town, and yet is not arrested for it by the humans. Must be the hammer."),
                    __("This movie is about 90 minutes of constant explosions and lensflares.")])
    elif "horror" in Player.RecentActions: 
        $ Line = renpy.random.choice([__("You watch the movie, which is about an adorkable girl who can't choose between two hunky guys. She picks the other one. The guys are a fishman and a skeleton."), 
                    __("You watch the movie, which is about a girl who is mercilessly stalked by some weird guy, until she eventually gives in and marries him. Her life is an endless hell."), 
                    __("In this movie, a group of teens are trapped in a wilderness cabin. They have a lot of random sex as some shadowy monster kills them one by one."), 
                    __("In this movie, a group of teens are trapped in an abandoned motel. They have a lot of random sex as some shadowy monster kills them one by one."), 
                    __("This movie is about a girl who's convinced to live in a sex dungeon, and she's eventually murdered."),
                    __("In this movie, a group of teens are trapped in a spaceship. They have a lot of random sex as some shadowy monster kills them one by one.")])
    elif "drama" in Player.RecentActions: 
        $ Line = renpy.random.choice([__("You watch the movie, which is about a mature woman who can't choose between two eligible widowers. She picks the other one."), 
                    __("You watch the movie, which is a documentary about a girl who is mercilessly stalked by some weird guy, until she eventually decides she gets a restraining order."), 
                    __("In this movie, which is a biopic about a great historical leader."), 
                    __("You watch the movie, in which a disabled person struggles with his various disabilities, and eventually overcomes them, and/or dies."),
                    __("This movie is about a lot of yelling and crying as some very serious issues are explored by an ensemble cast.")])
