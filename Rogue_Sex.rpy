...
label Rogue_Masturbate: #(Situation = Situation):
    ...
    #Second time+ initial dialog
            ...
            if RogueX.Forced: 
                ...
                $ RogueX.FaceChange("sexy", 1)
                $ Line = renpy.random.choice([__("You enjoyed the show?"),       
                    __("Didn't get enough earlier?"),
                    __("It is nice to have an audience. . .")]) 
                ch_r "[Line]"            
            elif RogueX.Mast < 3:        
                $ RogueX.FaceChange("sexy", 1)
                ...
                $ RogueX.FaceChange("sexy", 1)
                $ RogueX.ArmPose = 2
                $ Line = renpy.random.choice([__("You sure do like to watch."),                 
                    __("So you'd like me to go again?"),                 
                    __("You want to watch some more?"),
                    __("You want me ta diddle myself?")]) 
                ch_r "[Line]"
                $ Line = 0
    ...
    if Approval >= 2:                                                                                
            if RogueX.Forced:
                ...
                $ Line = renpy.random.choice([__("Well. . . ok."),                 
                    __("I suppose it would help to have something nice to look at. . ."),
                    __("I've kind of needed this anyways. . ."),
                    __("Sure!"), 
                    __("I guess I could. . . give it a go."),
                    __("Heh, ok, ok.")]) 
                ch_r "[Line]"
                $ Line = 0
    ...
    if not RogueX.Sex and Approval:                                                  #First time dialog        
        ...
        if RogueX.Forced: 
            ...
            $ Line = renpy.random.choice([__("Back again so soon?"),                 
                ...
                __("You can't stay away from this. . ."), 
                __("Didn't get enough earlier?"),
            ...
            $ Line = renpy.random.choice([__("You want some of this action?"),                 
                __("So you'd like another go?"),                 
                __("You can't stay away from this. . ."), 
                __("You want me to ride your pole?"),
                __("You wanna dip your wick?")]) 
            ch_r "[Line]"
        $ Line = 0
...
label Rogue_Sex_A:  
    ...
    if not RogueX.Anal and Approval:                                                 #First time dialog        
        ...
        if RogueX.Forced: 
            ...
            $ Line = renpy.random.choice([__("You want some of this action?"),                 
                __("So you'd like another go?"),                 
                __("You can't stay away from this booty."), 
                __("You want me to ride your pole?"),
                __("You wanna dip your wick?")]) 
            ch_r "[Line]"
        $ Line = 0
...
label Rogue_Sex_H:  
    ...
    if not RogueX.Hotdog and Approval:                                                 #First time dialog        
        ...
        if RogueX.Forced: 
            ...
            $ Line = renpy.random.choice([__("You want some of this action?"),                 
                __("So you'd like another go?"),                 
                __("You can't stay away from this booty."), 
                __("You want me to slick your pole?")]) 
            ch_r "[Line]"
        $ Line = 0
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        if RogueX.Forced:
            ...
            $ RogueX.Statup("Love", 80, 1)
            $ RogueX.Statup("Inbt", 50, 2) 
            $ Line = renpy.random.choice([__("Well, sure, give it a rub."),                 
                __("Well. . . ok."),                 
                __("Sure!"), 
                __("I guess we could do that."),
                __("Hells yeah."),
                __("Heh, ok, ok.")]) 
            ch_r "[Line]"
            $ Line = 0
