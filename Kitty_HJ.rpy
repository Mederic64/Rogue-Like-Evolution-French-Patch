    ...
    if not KittyX.Hand and Approval:                                                 #First time dialog        
        ...
        if KittyX.Forced: 
            ...
            $ Line = renpy.random.choice([__("Another one?"),   
                ...
                __("My hand's kinda sore from earlier."),
                __("My hand's kinda sore from earlier.")]) 
            ch_k "[Line]"
        elif KittyX.Hand < 3:        
            $ KittyX.FaceChange("sexy", 1)
            ...
            $ KittyX.FaceChange("sexy", 1)
            $ KittyX.ArmPose = 2
            $ Line = renpy.random.choice([__("You want some of this?"),                 
    ...
    if not KittyX.Tit and Approval:                                                 #First time dialog    
        ...
        if KittyX.Forced: 
            ...
            $ Line = renpy.random.choice([__("Back again so soon?"),   
                __("You're going to make me sore."), 
                __("Didn't get enough earlier?"),
                __("My tits are still kinda sore from earlier.")]) 
            ch_k "[Line]"
        elif KittyX.Tit < 3:        
            $ KittyX.FaceChange("sexy", 1)
            $ KittyX.Brows = "confused"
...
label Kitty_Blowjob:
    ...
    if not KittyX.Blow and Approval:                                                 #First time dialog        
        ...
        if KittyX.Forced: 
            ...
            $ KittyX.FaceChange("sexy", 1)
            $ Line = renpy.random.choice([__("Back again so soon?"),   
                __("You're going to give me lockhee- . . . jaw."), 
        ...
        menu:
            ...
            "Come on, please?":             
                if Approval:
                    ...
                    $ KittyX.Statup("Inbt", 70, 3) 
                    $ KittyX.Statup("Inbt", 40, 2) 
                    $ Line = renpy.random.choice([__("Well, sure, I guess."),                 
                        __("Well. . . ok."),                 
                        __("I could maybe give it a try."), 
                        __("I guess I could. . ."),
                        __("Fiiine. . . [She licks her lips]."),
                        "Heh, ok, fine."]) 
                    ch_k "[Line]"
                    $ Line = 0                   
                    jump Kitty_BJ_Prep
    ...
    if not KittyX.Foot and Approval:                                                 #First time dialog        
        ...
        if KittyX.Forced: 
            ...
            $ Line = renpy.random.choice([__("You want me to use my feet?"),                 
                __("So you'd like another foot sesh?"),                 
                __("A little. . . [she rubs her foot along your leg]?"), 
                "A little TLC?"]) 
            ch_k "[Line]"
        $ Line = 0
