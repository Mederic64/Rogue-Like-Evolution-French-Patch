...
label Laura_Masturbate: #(Situation = Situation):
    ...
    #Second time+ initial dialog
            ...
            if LauraX.Forced: 
                ...
                $ LauraX.FaceChange("sexy", 1)
                $ Line = renpy.random.choice([__("Did you enjoy that?"),       
                    __("Didn't get enough earlier?"),
                    __("I liked having an audience. . .")]) 
                ch_l "[Line]"            
            elif LauraX.Mast < 3:        
                $ LauraX.FaceChange("sexy", 1)
                ...
                $ LauraX.FaceChange("sexy", 1)
                $ LauraX.ArmPose = 2
                $ Line = renpy.random.choice([__("You like to watch."),                 
                    __("Again?"),                 
                    __("You really like to watch me."),
                    __("You want me to masturbate again?")]) 
                ch_l "[Line]"
                $ Line = 0
    ...
    if Approval >= 2:                                                                                
            if LauraX.Forced:
                ...
                $ Line = renpy.random.choice([__("Huh. Ok."),                 
                    __("Couldn't hurt. . ."),
                    __("Allright."), 
                    __("Sure."),
                    __("Heh, ok.")]) 
...
label Laura_Sex_P:  
    ...
    if not LauraX.Sex and Approval:                                                  
            ...
            if LauraX.Forced: 
                ...
                $ Line = renpy.random.choice([__("Back again?"),                 
                    ...
                    __("I must be better than I thought."), 
                    __("Didn't get enough earlier?"),
                    __("Your funeral, ") + LauraX.Petname + __(".")]) 
                ch_l "[Line]"
            elif LauraX.Sex < 3:        
                $ LauraX.Brows = "confused"
                $ LauraX.Mouth = "kiss"
                ...
                $ Line = renpy.random.choice([__("Oh, you want some of this?"),                 
                    __("You'd like another round?"),                 
                    __("I must be better than I thought."), 
                    __("I hope you don't plan on wearing me out."),
                    __("You want to plow me?")]) 
                ch_l "[Line]"
            $ Line = 0
    ...
    if Approval >= 2:                                                                  
            ...
            if LauraX.Forced:
                ...
                $ LauraX.Statup("Love", 90, 1)
                $ LauraX.Statup("Inbt", 50, 3) 
                $ Line = renpy.random.choice([__("Well. . . fine, let's do it."),                 
                    __("Sure."), 
                    __("We could, I guess."),
                    __("Hmmm, sure."),
                    __("Sounds fun.")]) 
            ...
            menu:
                ...
                "I think you'd enjoy it as much as I would. . .":             
                        if Approval:
                            ...
                            $ LauraX.Statup("Inbt", 70, 3) 
                            $ LauraX.Statup("Inbt", 40, 2) 
                            $ Line = renpy.random.choice([__("Yeah, probably. . ."),     
                                __("I guess. . ."), 
                                __("Good point. . .")]) 
                            ch_l "[Line]"
                            $ Line = 0                   
