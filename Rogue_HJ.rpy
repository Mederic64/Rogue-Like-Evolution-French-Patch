...
label Rogue_Handjob:
    ...
    if not RogueX.Hand and Approval:                                                 #First time dialog        
        ...
        if RogueX.Forced: 
            ...
            $ Line = renpy.random.choice([__("Back again so soon?"),   
                __("You're going to give me calluses."), 
                __("Didn't get enough earlier?"),
                __("My arm's still a bit sore from earlier."),
                __("My arm's still a bit sore from earlier.")]) 
            ch_r "[Line]"
        elif RogueX.Hand < 3:        
            $ RogueX.FaceChange("sexy", 1)
            ...
            $ Line = renpy.random.choice([__("You want some of this action?"),                 
                __("So you'd like another handy?"),                 
                __("A little. . . [fist pumping hand gestures]?"), 
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        if RogueX.Forced:
            ...
            $ Line = renpy.random.choice([__("Well, sure, put'im here."),                 
                __("Well. . . ok."),                 
                __("I suppose, drop trou."), 
                __("I guess I could. . . whip it out."),
        ...
        menu:
            ...
            "I'd really appreciate it. . .":             
                if Approval:
                    ...
                    $ Line = renpy.random.choice([__("Sure, put'im here."),                 
                        __("No Problem."),                 
                        __("Sure. Drop trou."), 
                        __("I suppose, whip it out."),
                        __("Ok, [She gestures for you to come over]."),
                        "Heh, ok."]) 
                    ch_r "[Line]"
                    $ Line = 0                   
                    jump Rogue_HJ_Prep
...
label Rogue_Titjob:
    ...
    if not RogueX.Tit and Approval:                                                 #First time dialog    
        ...
        if RogueX.Forced: 
            ...
            $ Line = renpy.random.choice([__("Back again so soon?"),   
                __("You're going to give me calluses."), 
                __("Didn't get enough earlier?"),
                __("My tits are still a bit sore from earlier.")]) 
            ch_r "[Line]"
        elif RogueX.Tit < 3:        
            $ RogueX.FaceChange("sexy", 1)
            $ RogueX.Brows = "confused"
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        if RogueX.Forced:
            ...
            $ RogueX.Statup("Love", 90, 1)
            $ RogueX.Statup("Inbt", 50, 3) 
            $ Line = renpy.random.choice([__("Well, sure, put it here."),                 
                __("Well. . . ok."),                 
                __("Yum."), 
                __("Sure, whip it out."),
        ...
        menu:
            ...
            "I think this could be fun for both of us. . .":             
                if Approval:
                    ...
                    $ RogueX.Statup("Inbt", 70, 3) 
                    $ RogueX.Statup("Inbt", 40, 2) 
                    $ Line = renpy.random.choice([__("Well, ok, put it here."),                 
                        __("Well. . . ok."),                 
                        __("I guess."), 
                        __("I guess, whip it out."),
                        __("Fine. . . [She drools a bit into her cleavage]."),
                        "Heh, ok, alright."])
                    ch_r "[Line]"
                    $ Line = 0                   
...
label Rogue_Blowjob:
    ...
    if not RogueX.Blow and Approval:                                                 #First time dialog        
        ...
        if RogueX.Forced: 
            ...
            $ RogueX.FaceChange("sexy", 1)
            $ Line = renpy.random.choice([__("Back again so soon?"),   
                __("You're going to give me lockjaw."), 
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        if RogueX.Forced:
            ...
            $ RogueX.Statup("Love", 90, 1)
            $ RogueX.Statup("Inbt", 50, 3) 
            $ Line = renpy.random.choice([__("Well, sure, ahhhhhh."),                 
                __("Well. . . ok."),                 
                __("Yum."), 
                __("Sure, whip it out."),
        ...
        menu:
            ...
            "Come on, please?":             
                if Approval:
                    ...
                    $ Line = renpy.random.choice([__("Well, sure, ahhhhhh."),                 
                        __("Well. . . ok."),                 
                        __("I guess a taste couldn't hurt."), 
                        __("I guess I could. . . whip it out."),
                        __("Fine. . . [She licks her lips]."),
                        "Heh, ok, alright."]) 
                    ch_r "[Line]"
...
label Rogue_Dildo_Ass:
    ...
    if not RogueX.DildoA and Approval:                                                 
            ...
            if RogueX.Forced: 
                ...
                $ Line = renpy.random.choice([__("You want some of this action?"),                 
                    __("So you'd like another go?"),                 
                    __("You want to stick it in my ass again?"),
                    __("You want me ta lube up your toy?")]) 
                ch_r "[Line]"
                $ Line = 0
...
label Rogue_Footjob:
    ...
    if not RogueX.Foot and Approval:                                                 #First time dialog        
        ...
        if RogueX.Forced: 
            ...
            $ RogueX.FaceChange("sexy", 1)
            $ Line = renpy.random.choice([__("Another one?"),   
                __("You're going to give me calluses."), 
                __("Didn't get enough earlier?"),
                __("My feet are a bit sore from earlier."),
                __("My feet are kinda sore from earlier.")]) 
            ch_r "[Line]"
        elif RogueX.Foot < 3:        
            $ RogueX.FaceChange("sexy", 1)
            $ RogueX.Brows = "confused"
            ...
            $ RogueX.FaceChange("sexy", 1)
            $ RogueX.ArmPose = 2
            $ Line = renpy.random.choice([__("You want me to use my feet?"),                 
                __("So you'd like another foot rub?"),                 
                __("So you'd like me to. . . [she rubs her foot along your leg]?"), 
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        if RogueX.Forced:
            ...
            $ RogueX.Statup("Love", 90, 1)
            $ RogueX.Statup("Inbt", 50, 3) 
            $ Line = renpy.random.choice([__("Sure, I guess."),                 
                __("Okay."),                 
                __("Ok, lemme see it."), 
                __("I guess. . ."),
                __("Ok. . . [She gestures for you to come over]."),
