...
label Primary_SexDialog(GirlA=Primary,TempLine = 0, TempLust = 0, TempLust2 = 0):   #nee Rog*ue_SexDialog(TempLine = 0, TempLust = 0, TempLust2 = 0) 
    ...
    if Trigger == "hand":
            ...
            if GirlA in (EmmaX,LauraX):
                        ...
                        if Speed <= 1:                      
                            #slow 
                            $ Line = Line + renpy.random.choice([__("Her movements have become masterful, her slightest touch starts you twitching"), 
                                    __("She gently blows across the tip as her finger dance along the shaft. It's getting a bit hot in here"), 
                                    __("She slowly caresses you in a way that makes your blood boil, then pulls back at the last second"),
                                    __("She knows what to do now, and rubs your cock with smooth strokes, focusing occasionally on the head"),
                                    __("She moves very smoothly, stroking casually and very gently, like she's been doing this for years"),
                                    __("You can't tell where she is at any moment, all you know is that it works")])   
                            $ TempFocus += 20 if Player.Focus > 70 else 7
                        else:                              
                            #fast
                            $ Line = Line + renpy.random.choice([__("Her movements have become masterful, her slightest touch starts you twitching"), 
                                    __("She gently blows across the tip as her finger dance along the shaft. It's getting a bit hot in here"), 
                                    __("Her expert strokes will have you boiling over in seconds"),
                                    __("She knows what to do now, and rubs your cock with smooth strokes, focusing occasionally on the head"),
                                    __("She moves very smoothly, stroking casually and very gently, you can tell she's had plenty of practice"),
                                    __("You can't tell where she is at any moment, all you know is that it works")]) 
                        ...
                        if Speed <= 1:                      
                            #slow 
                            $ Line = Line + renpy.random.choice([__("Her movements have become almost masterful, her slightest touch starts you twitching"), 
                                    __("She gently blows across the tip as her finger dance along the shaft. It's getting a bit hot in here"), 
                                    __("She's becoming something of an expert, making up for years of lost time"),
                                    __("She slowly caresses you in a way that makes your blood boil, then pulls back at the last second"),
                                    __("She knows what to do now, and rubs your cock with smooth strokes, focusing occasionally on the head"),
                                    __("She moves very smoothly, stroking casually and very gently, like she's been doing this for years"),
                                    __("You can't tell where she is at any moment, all you know is that it works")])   
                        ...
                        if Speed <= 1:                      
                            #slow
                            $ Line = Line + renpy.random.choice([__("She's begining to figure things out, her fingers cause tingles as they caress the shaft"), 
                                    __("She's still learning, but learning fast. Her hands sure are smooth"), 
                                    __("She has a smooth motion going now, gentle and precise"),
                                    __("Her lessons are paying off, she's really becoming very talented at this"),
                                    __("She gently caresses the shaft, and cups the balls in her other hand, giving them a warm massage")])  
                            $ TempFocus += 15 if Player.Focus > 60 else 5
                        else:                               
                            #fast
                            $ Line = Line + renpy.random.choice([__("She's begining to figure things out, her fingers cause tingles as they caress the shaft"), 
                                    __("She's still learning, but learning fast. Her hands sure are smooth"), 
                                    __("Her hands glide smoothly across your cock"),
                                    __("She has a smooth motion going now, gentle and precise"),
                                    __("Her lessons are paying off, she's really becoming very talented at this"),
                                    __("She quickly strokes your cock, with a very deft pressure")]) 
                            $ TempFocus += 15 if Player.Focus < 60 else 7   
            else:                                   
                    #First and second time
                    if Speed <= 1:                      
                        #slow
                        $ Line = Line + renpy.random.choice([__("She makes up for her inexperience with determination, carefully stroking your cock"), 
                                __("She moves her hands up and down the shaft. She's a little rough at this, but at least she tries"), 
                                __("She strokes you gently. She isn't quite sure what to make of the balls"),
                                __("Her fingers fumble with your shaft a bit"),
                                __("She squeezes one of your balls too tightly, but stops when you wince"),
                                __("She has a firm grip, and she's not letting go. This may take a few tries")])   
                        $ TempFocus += 12 if Player.Focus > 60 else 5         
                    else:                               
                        #fast 
                        $ Line = Line + renpy.random.choice([__("She really wasn't prepared for speeding up, and your cock often slips out of her hand"), 
                                __("She rapidly moves her hands up and down the shaft. She's a little rough at this, but at least she tries"), 
                                __("She strokes you a bit too quickly, the friction is a bit uncomfortable"),
                                __("Her fingers fumble with your shaft a bit"),
                                __("She squeezes one of your balls too tightly, but stops when you wince"),
                                __("She has a firm grip, and she's not letting go. This train is out of control")])  
    ...
    #End Action Titfuck ///////////////////////////////////////////////////////////////////////////////
            ...
            if Speed == 1:                                                                 
                    ...
                    if GirlA.Blow > 4 or GirlA in (EmmaX,LauraX):                                                                 
                            #After the 5th time
                            $ Line = Line + renpy.random.choice([__("Her deft licks are masterful, your cock twitches with each stroke"), 
                                    __("She gently blows across the head as she covers your cock in smooth licks"), 
                                    __("How many licks to the center of your cock? No way you're finding out"),
                                    __("She's becoming something of an expert, making up for years of lost time"),
                                    __("She's really getting good at this, alternating between deep suction and gentle licks"),
                                    __("She moves very smoothly, tongue dancing casually and very gently, like she's been doing this for years"),
                                    __("She puts the tip into her mouth and her tounge dances around it")])  
                            $ TempFocus += 20 if Player.Focus < 70 else 15                   
                            $ TempLust += 2 if GirlA.Lust > 80 else 1
                        
                    elif GirlA.Blow > 1:                                                               
                            #After the 2nd time
                            $ Line = Line + renpy.random.choice([__("She's begining to figure things out, her tongue makes your hair stand on end"), 
                                    __("She's still learning, but learning fast. She seems eager to use her mouth for more than talk"), 
                                    __("She's settled into a gentle licking pace that washes over you like a warm bath"),
                                    __("She licks gently up and down the shaft. She's a little rough at this, but at least she tries"), 
                                    __("Her tongue moves carefully along the shaft"),
                                    __("She's really starting to learn some clever tricks to making you feel good"),
                                    __("She licks her way down the shaft, and gently teases the balls")]) 
                    ...
                    if GirlA.Blow > 4 or GirlA in (EmmaX,LauraX):                                                                  
                            #After the 5th time
                            $ Line = Line + renpy.random.choice([__("She masterfully bobs on your cock, and it twitches with each stroke"), 
                                    __("She rapidly bobs up and down on your cock, a frenzy of motion"), 
                                    __("She's becoming something of an expert, making up for years of lost time"),
                                    __("She's really getting good at this, alternating between deep suction and quick licks across the head"),
                                    __("She moves very smoothly, bobbing in and out like she's been doing this for years"),
                                    __("She puts the tip into her mouth and her tounge swirls rapidly around it")]) 
                            $ TempFocus += 20 if Player.Focus < 80 else 10                      
                            $ TempLust += 2 if GirlA.Lust > 70 else 1    
                        
                    elif GirlA.Blow > 1:                                                                
                            #After the 2nd time
                            $ Line = Line + renpy.random.choice([__("She's begining to figure things out, she bobs carefully up and down the head"), 
                                    __("She's still learning, but learning fast. She keeps her teeth well clear, aside from a playful nip"), 
                                    __("Her lips envelope you like a warm bath as she bobs in and out"),
                                    __("She's really starting to learn some clever tricks to making you feel good"),
                                    __("She rapidly licks her way around the head"),
                                    __("Her mouth envelopes the head, then she quickly draws it in and draws back with a pop")]) 
                            $ TempFocus += 15 if Player.Focus > 80 else 10                      
                            $ TempLust += 1 if GirlA.Lust > 60 else 0    
                        
                    else:                                                                           
                            # First and second time
                            $ Line = Line + renpy.random.choice([__("She really wasn't prepared for speeding up, and your cock often pops out of her mouth"), 
                                    __("She puts the tip in her mouth and starts to actually suck in as hard as she can. She's a little rough at this, but at least she tries"),             
                                    __("Her head bobs rapidly, until she goes a bit too deep and starts to gag"),
                                    __("She lets her teeth get a bit too much action"),
                                    __("She bobs quickly on your cock, but clamps down a bit too tight for comfort")]) 
                    ...
                    if GirlA.Blow > 4 or GirlA in (EmmaX,LauraX):                                                                  
                            #After the 5th time
                            $ Line = Line + renpy.random.choice([__("She masterfully bobs on your cock, and it twitches with each stroke"), 
                                    __("She smoothly bobs up and down on your cock, a frenzy of motion"), 
                                    __("She's becoming something of an expert, making up for years of lost time"),
                                    __("She gobbles you up all the way to the base, then quickly draws out and plunges back in"),
                                    __("She's really getting good at this, alternating between deep suction and quick licks across the head"),
                                    __("She moves very smoothly, bobbing in and out like she's been doing this for years"),
                                    __("She puts the shaft into her mouth and her tounge swirls rapidly around it")]) 
                            $ TempFocus += 22 if Player.Focus > 40 else 10                      
                            $ TempLust += 3 if GirlA.Lust > 60 else 1    
                        
                    elif GirlA.Blow > 1:                                                               
                            #After the 2nd time
                            $ Line = Line + renpy.random.choice([__("She's begining to figure things out, she bobs carefully up and down the shaft"), 
                                    __("She's still learning, but learning fast. She keeps her teeth well clear, aside from a playful nip"), 
                                    __("Her lips envelope you like a warm bath as she bobs in and out"),
                                    __("She slowly draws you in to the base of your cock, then pulls back at the last second"),
                                    __("She's really starting to learn some clever tricks to making you feel good"),
                                    __("She rapidly licks her way up and down the shaft as her mouth envelopes you"),
                                    __("Her mouth envelopes the shaft, then she quickly draws it in and draws back with a pop")])
                            $ TempFocus += 15 if Player.Focus > 50 else 5  
                        
                    else:                                                                          
                            #First and second time
                            $ Line = Line + renpy.random.choice([__("She really wasn't prepared for putting it all the way in, and grimaces at the taste"), 
                                    __("She puts the tip in her mouth and starts to actually suck in as hard as she can. She's a little rough at this, but at least she tries"), 
                                    __("She sucks up and down your cock very quickly, but gets a bit dizzy and has to slow down"),
                                    __("Her head bobs rapidly, until she goes a bit too deep and starts to gag"),
                                    __("She lets her teeth get a bit too much action"),
                                    __("She bobs quickly on your cock, but clamps down a bit too tight for comfort")]) 
                    ...
                    if GirlA.Blow > 4 or GirlA in (EmmaX,LauraX):                                                                 
                            #After the 5th time
                            $ Line = Line + renpy.random.choice([__("She masterfully bobs on your cock, and it twitches with each stroke"), 
                                    __("She rapidly bobs to the base of your cock, a frenzy of motion"), 
                                    __("She's becoming something of an expert, making up for years of lost time"),
                                    __("She gobbles you up all the way to the base, then quickly draws out and plunges back in"),
                                    __("She's really getting good at this, alternating between deep suction and quick licks across the head"),
                                    __("She moves very smoothly, bobbing in and out like she's been doing this for years"),
                                    __("She puts the entire shaft into her mouth and her tounge swirls rapidly around it")])  
                            ...
                            $ Line = Line + renpy.random.choice([__("She's begining to figure things out, she bobs carefully up and down the shaft"), 
                                    ...
                                    __("She slowly draws you in to the base of your cock, then pulls back at the last second"),
                                    __("She's really starting to learn some clever tricks to making you feel good"),
                                    __("She completely envelops the shaft with her throat."),
                                    __("Her mouth envelopes the head, then she quickly draws it all the way in and draws back with a pop")])  
                            $ TempFocus += 20 if Player.Focus > 40 else 5                      
                            $ TempLust += -3 if GirlA.Lust < 60 else -1                        
                            ...
                            #First and second time
                            $ Line = Line + renpy.random.choice([__("She really wasn't prepared for going so deep, and gags a bit"), 
                                    __("She puts the whole shaft in her mouth and starts to actually suck in as hard as she can. She's a little rough at this, but at least she tries"), 
                                    __("She draws your cock into her mouth very qucikly, but gets a bit dizzy and has to slow down"),
                                    __("Her head bobs rapidly, until she goes a bit too deep and starts to gag"),
                                    __("She lets her teeth get a bit too much action"),
                                    __("She bobs quickly on your cock, but clamps down a bit too tight for comfort")]) 
    ...
    # end GirlA.Blowjob                                 //////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed:
                    #if Rog*ue is not moving   
                    $ Line = __("She seems to be waiting for you to do something. . ")
                    return
                        
            elif Speed < 2: 
                    $ Line = __("You continue to pound "+ GirlA.Name + ". ")
                    #if Rog*ue is the primary but is licking
            else: 
                    $ Line = __("You continue to slowly drive into " + GirlA.Name + ". ")
                    #if Rog*ue is the primary and is heading or sucking
            
            if GirlA.Sex > 4 or GirlA in (EmmaX,LauraX):
                if Speed > 1:                       
                        # After the 5th time fast
                        $ Line = Line + renpy.random.choice([__("She bounces rapidly against your cock"), 
                            __("You thrust into her and she squeaks a bit"),
                            __("You quickly grind back and forth inside her"),
                            __("You alternate between shallow rapid thrusts, and the occasional deep, slow one"),
                            __("You pound away at her"),    
                            __("She grinds furiously back and forth along your cock")])
                        $ TempFocus += 18 if Player.Focus > 50 else 12                   
                        $ TempLust += 16 if GirlA.Lust > 70 else 10                    
                else:                      
                        # After the 5th time slow
                        $ Line = Line + renpy.random.choice([__("She bumps slowly against your cock"), 
                            __("You thrust into her and she coos a bit"),
                            __("You slowly grind back and forth inside her"),
                            __("You alternate between long and slow thrusts, and the occasional quick one"),
                            __("You slowly slide back and forth near the entrance"),    
                            __("She slides slowly back and forth along your cock, teasing you")])
                ...
                if Speed > 1:            
                    ...
                    $ Line = Line + renpy.random.choice([__("she bumps slowly against your cock"), 
                        ...
                        __("You alternate between long and slow thrusts, and the occasional quick one"),
                        __("You slowly slide back and forth near the entrance"),    
                        __("She slides slowly back and forth along your cock")])
                ...
                if Speed > 1:           
                    ...
                    $ Line = Line + renpy.random.choice([__("She bounces rapidly against your cock"), 
                        __("You thrust into her and she squeeks in pain"),
                        __("You quickly grind back and forth inside her but she doesn't seem to have the rhythm down"),
                        __("She bounces rapidly against your cock, occasionally popping out and having to stick it back in"),
                        __("You pound away at her"),    
                        __("She moves rapidly back and forth along your cock, but seems a bit uncomfortable")])
    ...
    # end GirlA.Sex                                 ////////////////////////////////////////////////////////////////////////////// 
            ...
            if not Speed:
                ...
                return
                    ...
                    $ Line = __("You continue to hotdog " + GirlA.Name + ". ")
            else: 
                    $ Line = __("You continue to grind against " + GirlA.Name + ".")
                    
            if GirlA.Hotdog >= 2:
                if Speed > 1:      
                    # After the 2ndtime fast
                    $ Line = Line + renpy.random.choice([__("She bounces rapidly against your cock"), 
                        __("You thrust against her and she squeaks a bit"),
                        __("You quickly grind back and forth along her crack"),
                        __("You alternate between shallow rapid thrusts, and the occasional deep, slow one"),
                        __("You grind away at her"),    
                        __("She grinds furiously back and forth along your cock")])
                    ...
                    #2nd time slow
                    $ Line = Line + renpy.random.choice([__("She grinds slowly against your cock"), 
                        __("You thrust against her and she coos a bit"),
                        __("You slowly rub the tip across her pussy"),
                        __("You alternate between long and slow thrusts, and the occasional rapid ones"),
                        __("You slowly slide back and forth near her rim"),    
                        __("She slides slowly back and forth along your cock, teasing you")])                    
                ...
                if Speed > 1:     
                    #fast
                    $ Line = Line + renpy.random.choice([__("She bounces rapidly against your cock"), 
                        __("You thrust into her and she squeeks in surprise"),
                        __("You quickly grind back and forth against her but she doesn't seem to have the rhythm down"),
                        __("She bounces rapidly against your cock, occasionally sliding out and having to stick it back in"),
                        __("You pound away at her"),    
                        __("She moves rapidly back and forth along your cock, but seems a bit uncomfortable")])                    
                    ...
                    #slow
                    $ Line = Line + renpy.random.choice([__("She grinds slowly against your cock"), 
                        __("You thrust into her crack and she squeaks a bit"),
                        __("You slowly grind back and forth across her rear"),            
                        __("You slowly slide back and forth near her rim"),    
                        __("She slides slowly back and forth along your cock")])
                    $ TempFocus += (TempLust2 + 5) if Player.Focus < 60 else (TempLust2 + 3)
    ...
    # end GirlA.Hotdog                                 //////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed:
                ...
                return
                    ...
                    $ Line = __("You continue to pound into " + GirlA.Name + "'s ass. ")
            else: 
                    $ Line = __("You continue to push into " + GirlA.Name + "'s ass. ")
            ...
            if GirlA.Anal >= 5:
                    if Speed > 1:
                            ...
                            $ Line = Line + renpy.random.choice([__("She bumps slowly against your cock"), 
                                ...
                                __("You slowly grind back and forth inside her"),
                                __("You alternate between long and slow thrusts, and the occasional quick one"),
                                __("You slowly slide back and forth near the rim"),    
                                __("She slides slowly back and forth along your cock, teasing you")])
                    ...
                    if Speed > 1:          
                            #fast
                            $ Line = Line + renpy.random.choice([__("She bounces rapidly against your cock but seems to be in pain"), 
                                __("You thrust into her and she squeeks in pain"),
                                __("You quickly grind back and forth inside her but she doesn't seem to have the rhythm down"),
                                __("She bounces rapidly against your cock, occasionally popping out and having to stick it back in"),
                                __("You pound away at her"),    
                            ...
                            #heading
                            $ Line = Line + renpy.random.choice([__("She grits her teeth and slides slowly against your cock"), 
                                __("You thrust into her and she squeaks a bit"),
                                __("You slowly grind back and forth inside her"),
                                __("You slowly slide back and forth near the rim"),    
                                __("She slides slowly back and forth along your cock")])  
    ...
    # end GirlA.Anal                                 //////////////////////////////////////////////////////////////////////////////
                    ...
                    $ Line = __("You continue to fondle " + GirlA.Name + ". ")
                    if not GirlA.Uptop and GirlA.Over and GirlA.Chest: 
                                #Full top
                                $ Line = Line + renpy.random.choice([__("You reach under her layers of clothing and massage her breasts"), 
                                    __("You pass your hands gently over her warm breasts"), 
                                    __("Her firm nipples catch on the fabric of her top as you grasp her warm flesh"),
                                    __("She gasps as you grasp her under her top")])
                                $ TempFocus += 2 if Player.Focus < 40 else 1  
                                $ TempLust += 4 if GirlA.Lust > 50 else 2
                    elif not GirlA.Uptop and GirlA.Over:        
                                #Just overtop
                                $ Line = Line + renpy.random.choice([__("You reach under her top and massage her breasts"), 
                                    __("You pass your hands gently over her warm breasts"), 
                                    __("Her nipples catch on the fabric of her top as you grasp her warm flesh, you can see them stiffen"),
                                    __("She gasps as you grasp her under her ") + GirlA.Over])
                                $ TempFocus += 2 if Player.Focus < 50 else 1
                                $ TempLust += 4 if GirlA.Lust > 50 else 2   
                    elif not GirlA.Uptop and GirlA.Chest:      
                                #just bra
                                $ Line = Line + renpy.random.choice([__("You reach under her ") + GirlA.Chest + __(" and massage her breasts"), 
                                    __("You pass your hands gently over her warm breasts"), 
                                    __("Her nipples catch on the fabric of her ") + GirlA.Chest + __(" as you grasp her warm flesh, you can see them stiffen"),
                                    __("She gasps as you grasp her under her ") + GirlA.Chest])
                                $ TempFocus += 3 if Player.Focus < 60 else 2    
                                $ TempLust += 5 if GirlA.Lust > 50 else 2    
                    elif GirlA.Pierce: 
                                #pierced
                                $ Line = Line + renpy.random.choice([__("You reach out and massage her glorious breasts"), 
                                    __("You pass your hands gently over her warm breasts, and blow across her pierced nipples"), 
                                    __("Her piercings catch lightly on your fingers as you grasp her warm flesh, you can see the nipples stiffen"),
                                    __("She gasps as you lightly thumb across her pierced nipples")])
                                $ TempFocus += 4 if Player.Focus < 70 else 2 
                                $ TempLust += 6 if GirlA.Lust > 40 else 4  
                    else: #topless
                                $ Line = Line + renpy.random.choice([__("You reach out and massage her glorious breasts"), 
                                    __("You pass your hands gently over her warm breasts, and blow across her nipples"), 
                                    __("Her nipples catch lightly on your fingers as you grasp her warm flesh, you can see them stiffen"),
                                    __("She gasps as you lightly thumb her rigid nipples")])
                                $ TempFocus += 4 if Player.Focus < 60 else 2 
                                $ TempLust += 6 if GirlA.Lust > 50 else 3  
                    if D20S > 18:
                            if GirlA == KittyX:
                                    $ Line = __("You continue to fondle " + GirlA.Name + ". They fit comfortably into your palms.")
                            elif GirlA == EmmaX:
                                    $ Line = __("You continue to fondle " + GirlA.Name + ". You can barely wrap your hands around them.")
                    $ GirlA.Addict -= 2
                  
    # end Fondle breasts                                 //////////////////////////////////////////////////////////////////////////////
    elif Trigger == "suck breasts":  
                    $ Line = __("You continue to suck on " + GirlA.Name + "'s breasts. ")
                    if not GirlA.Uptop and GirlA.Over and GirlA.Chest: 
                                #Full top
                                $ Line = renpy.random.choice([__("You bend down and motor-boat her breasts"),
                                        __("You gently nibble at her nipples as you suck on them through the layered tops"),
                                        __("You  place a nipple between your lips, and give it a quick tug through the ") + GirlA.Over,
                                        __("She gasps as you gently nibble her rigid nipples poking through her tops")])      
                                $ TempFocus += 2 if Player.Focus < 50 else 1  
                                $ TempLust += 2 if GirlA.Lust < 30 else 1
                    elif not GirlA.Uptop and GirlA.Over:        
                                #Just overtop
                                $ Line = renpy.random.choice([__("You bend down and motor-boat her breasts"),
                                        __("You gently nibble at her nipples as you suck on them through the ") + GirlA.Over,
                                        __("You tease her nipples with your tongue through the fabric"),
                                        __("You slowly lick her nipples through her moist top"), 
                                        __("You gently place a nipple between your lips, and draw it out until it releases with a *pop*"),
                                        __("She gasps as you lightly lick her rigid nipples, poking through her top")])    
                                $ TempFocus += 2 if Player.Focus < 50 else 1
                                $ TempLust += 5 if GirlA.Lust > 50 else 3
                    elif not GirlA.Uptop and GirlA.Chest:      
                                #just bra
                                $ Line = renpy.random.choice([__("You bend down and motor-boat her breasts"),
                                        __("You tease her nipples with your tongue through her ") + GirlA.Chest,
                                        __("You slowly lick her nipples through her moist ") + GirlA.Chest, 
                                        __("You gently place a nipple between your lips, and draw it out until it releases with a *pop*"),
                                        __("She gasps as you lightly lick her rigid nipples, poking through her ") + GirlA.Chest])   
                                $ TempFocus += 4 if Player.Focus < 60 else 3    
                                $ TempLust += 5 if GirlA.Lust > 50 else 2    
                    elif GirlA.Pierce: 
                                #pierced
                                $ Line = renpy.random.choice([__("You bend down and motor-boat her breasts"),
                                    __("You gently nibble at her nipples as you suck on them"),
                                    __("You tease her piercings with your tongue"),
                                    __("You slowly lick around, and then blow across her nipples"), 
                                    __("You gently place a pierced nipple between your lips, and draw it out until it releases with a *pop*"),
                                    __("She gasps as you lightly lick her rigid nipples")])
                                ...
                                $ Line = renpy.random.choice([__("You bend down and motor-boat her breasts"),
                                    __("You gently nibble at her nipples as you suck on them"),
                                    __("You tease her nipples with your tongue"),
                                    __("You slowly lick around, and then blow across her nipples"), 
                                    __("You gently place a nipple between your lips, and draw it out until it releases with a *pop*"),
                                    __("She gasps as you lightly lick her rigid nipples")])
    ...
    # end Suck breasts                                 //////////////////////////////////////////////////////////////////////////////
                    ...
                    $ Line = __("You continue to massage " + GirlA.Name + "'s thighs. ")
                    
                    if GirlA.PantsNum() > 6 and not GirlA.Upskirt:
                                #she's wearing pants of some sort. . .
                                $ Line = renpy.random.choice([__("Her legs twitch a bit in her pants as you caress them"), 
                                        __("She gasps as you stroke her warm thighs through the pants"),
                                        __("You draw your hand from her knee to mid-thigh, and she gasps a little"),
                                        __("You slide a hand up her inner thigh, to just below her . . .")])                              
                                ...
                                $ Line = renpy.random.choice([__("You reach under skirt and stroke her thighs"), 
                                        __("You lift her skirt a bit and feel her firm thighs"), 
                                        __("Her legs twitch a bit beneath her skirt"),
                                        __("She gasps as you stroke her lightly covered thighs"),
                                        __("You slide a hand up her inner thigh, to just below her . . ")])
                                ...
                                $ Line = renpy.random.choice([__("You reach under skirt and stroke her thighs"), 
                                        __("You lift her skirt a bit and feel her firm thighs"), 
                                        __("Her legs twitch a bit beneath her skirt"),
                                        __("She gasps as you stroke her warm thighs"),
                                        __("You slide a hand up her inner thigh, to just above the hose")])
                                ...
                                $ Line = renpy.random.choice([__("You reach under skirt and stroke her thighs"), 
                                        ...
                                        __("She gasps as you stroke her warm thighs"),
                                        __("You draw your hand from her knee to mid-thigh, and she gasps a little"),
                                        __("You slide a hand up her inner thigh, to just her skirt")])
                                $ TempFocus += 2 if Player.Focus < 50 else 0  
                                $ TempLust += 2 if GirlA.Lust < 50 else 0                               
                                $ GirlA.Addict -= 2 if D20S > 10 else 1                                
                    elif GirlA.HoseNum() >= 5: 
                                # just hose
                                $ Line = renpy.random.choice([__("You reach out and stroke her lightly covered thighs"), 
                                        __("You lift her leg a bit and feel her firm thighs"), 
                                        __("Her legs twitch a bit beneath your hands"),
                                        __("She gasps as you stroke her warm thighs"),
                                        __("You slide a hand up her inner thigh, the smooth faberic creasing"),
                                        __("You slide a hand up her inner thigh, to just below her. . ")])
                                $ TempFocus += 2 if Player.Focus < 40 else 0  
                                $ TempLust += 2 if GirlA.Lust < 40 else 0                               
                                $ GirlA.Addict -= 1 if D20S > 10 else 0
                                ...
                                #just stockings
                                $ Line = renpy.random.choice([__("You reach out and stroke her thighs"), 
                                        __("You lift her leg a bit and feel her firm thighs"), 
                                        __("Her legs twitch a bit beneath your hands"),
                                        __("She gasps as you stroke her warm thighs"),
                                        __("You slide a hand up her inner thigh, to just above the hose"),
    ...
    # end fondle thighs                               //////////////////////////////////////////////////////////////////////////////
                    ...
                    if Speed == 2 and D20S <= 10:
                            $ Line = renpy.random.choice([__("You continue to finger ") + GirlA.Name + __("'s pussy. "), 
                                                    __("You continue to finger bang ") + GirlA.Name + __("'s pussy. "),
                                                    __("You continue to finger blast ") + GirlA.Name + __("'s pussy. ")])
                                            
                            if GirlA.PantsNum() > 6 and not GirlA.Upskirt:
                                            #pants
                                            $ Line = renpy.random.choice([__("You slide a hand down her pants, and slide your fingers into her pussy underneath"), 
                                                    __("You push her panties aside, and slide a finger between her lips"), 
                                                    __("You slide a finger into her pussy and stroke the top"), 
                                                    __("You pull her pants out a bit and she gasps as you slide two fingers between her lips"), 
                                                    __("You rub her clit with your palm as you dive into her pussy with your middle finger")]) 
                            elif GirlA.PantsNum() == 5:
                                    if GirlA.Panties and not GirlA.PantiesDown: 
                                            #Just panties
                                            $ Line = renpy.random.choice([__("You push her skirt and ") + GirlA.Panties + __(" aside, and slide a finger between her lips"), 
                                                    __("You slide a finger under her ") + GirlA.Panties + __(" and stroke the top or her pussy"), 
                                                    __("You lift her skirt a bit and she gasps as you pull her ") + GirlA.Panties + __(" aside and slide two fingers between her lips"), 
                                                    __("You rub her clit with your thumb as you dive into her pussy with your middle finger")])
                                    else: #skirt, but nothing else
                                            $ Line = renpy.random.choice([__("You push her skirt aside, and slide a finger between her lips"), 
                                                    __("You slide a finger into her pussy and stroke the top"), 
                                                    __("You lift her skirt a bit and she gasps as you slide two fingers between her lips"), 
                                                    __("You rub her clit with your thumb as you dive into her pussy with your middle finger")]) 
                                            $ TempFocus += 2 
                                            $ TempLust += 2                            
                            #no skirt or pants
                                        ...
                                        # just shorts on
                                        $ Line = renpy.random.choice([__("You slide a hand down her shorts, and slide your fingers into her pussy underneath"), 
                                                __("You push her shorts up, and slide a finger between her lips"), 
                                                __("You slide a finger along her pussy and stroke to the top"), 
                                                __("You pull her shorts out a bit and she gasps as you slide two fingers between her lips"),                                                 
                                                __("You rub her clit with your palm as you dive into her pussy with your middle finger")])  
                            elif GirlA.Panties and not GirlA.PantiesDown: 
                                        #Just panties
                                        $ Line = renpy.random.choice([__("You push her panties aside, and slide a finger between her lips"), 
                                                __("You slide a finger along her pussy and stroke to the top"), 
                                                __("You lift her panties a bit and she gasps as you slide two fingers between her lips")])
                            else: #nothing
                                        $ Line = renpy.random.choice([__("You reach out and slide a finger between her lips"), 
                                                __("You slide a finger along her pussy and stroke to the top"), 
                                                __("You lift her lips a bit and she gasps as you slide two fingers between them"), 
                                                __("You rub her clit with your thumb as you dive into her pussy with your middle finger")]) 
                                        $ TempFocus += 2 
                                        $ TempLust += 2
                            ...
                            $ Line = renpy.random.choice([__("You continue to stroke ") + GirlA.Name + __("'s pussy. "), 
                                                    __("You continue to rub ") + GirlA.Name + __("'s pussy. "),
                                                    __("You continue to caress ") + GirlA.Name + __("'s pussy. ")])
                                            
                            if GirlA.PantsNum() > 6 and not GirlA.Upskirt:
                                            #pants on
                                            $ Line = renpy.random.choice([__("You reach out and brush your hands across her pussy through the pants"), 
                                                    __("You slide a hand down her pants, and brush your hands across her pussy underneath"), 
                                                    __("You put your hand against her mound and grind against it"), 
                                                    __("You reach into her gap and she gasps as you slide your hand across and stroke her warm mound"), 
                                                    __("As you dig your thumb into her, she gasps and raises up a bit"),
                                                    __("She gasps as you reach under her and lightly stroke her ass through the pants"),
                                                    __("You slide a hand up her inner thigh, she moans a little as you reach the point where they meet")])
                                                
                            elif GirlA.PantsNum() == 5:
                                    if GirlA.Panties == "shorts" and not GirlA.PantiesDown: 
                                            #shorts on
                                            $ Line = renpy.random.choice([__("You reach under skirt and ran your hands over the thin shorts covering her"), 
                                                    __("You slide a hand up the leg of her shorts, and brush your hands across her pussy underneath"), 
                                                    __("You put your hand against her mound and grind against it"), 
                                                    __("You reach into her gap and she gasps as you slide your hand across and stroke her warm mound"), 
                                                    __("As you dig your thumb into her, she gasps and raises up a bit"),
                                                    __("She gasps as you reach under her and lightly stroke her ass through the thin shorts"),
                                                    __("You slide a hand up her inner thigh, she moans a little as you reach the point where they meet")]) 
                                    elif GirlA.Panties and not GirlA.PantiesDown: #Just panties
                                            $ Line = renpy.random.choice([__("You reach under skirt and brush across her panties"), 
                                                    __("You lift her skirt a bit and grind against her panties"), 
                                                    __("You lift her skirt a bit and she gasps as you pull her panties aside and stroke her lips"), 
                                                    __("Her legs twitch a bit beneath her skirt as you press your thumb against her"),
                                                    __("She gasps as you rub her pussy through her panties"),
                                                    __("You slide a hand up her inner thigh, she moans a little as you reach the point where they meet")])  
                                    elif GirlA.HoseNum() >= 5: 
                                            #just hose
                                            $ Line = renpy.random.choice([__("You reach out and brush your hands across her cleft through the thin fabric"), 
                                                    __("You grab her hose and pull them taut, elliciting a small gasp"),
                                                    __("You put your hand against her mound and grind against it"), 
                                                    __("You reach into her gap and she gasps as you slide your hand across and stroke her lips through the thin material"), 
                                                    __("Her legs twitch a bit as you press your thumb against her"),
                                                    __("She gasps as you reach under her hose and lightly stroke her ass"),
                                                    __("You slide a hand up her inner thigh, she moans a little as you reach the point where they meet")])
                                    else: #skirt, but nothing else
                                            $ Line = renpy.random.choice([__("You reach under skirt and brush across her bare lips"), 
                                                    __("You lift her skirt a bit and grind against her warm mound"), 
                                                    __("You lift her skirt a bit and she gasps as you stroke her moist lips"), 
                                                    __("Her legs twitch a bit beneath her skirt as you press your thumb against her"),
                                                    __("She gasps as you rub her bare pussy"),
                                                    __("You slide a hand up her inner thigh, she moans a little as you reach the point where they meet")])
                                            if D20S <= 10:
                            ...
                            #no skirt or pants
                                        ...
                                        # just shorts on
                                        $ Line = renpy.random.choice([__("You reach out and brush your hands across her pussy through the shorts"), 
                                                __("You slide a hand down her shorts, and brush your hands across her pussy underneath"), 
                                                __("You put your hand against her mound and grind against it"), 
                                                __("You reach into her gap and she gasps as you slide your hand across and stroke her warm mound"), 
                                                __("As you dig your thumb into her, she gasps and raises up a bit"),
                                                __("She gasps as you reach under her and lightly stroke her ass through the thin shorts"),
                                        ...
                                        #Just panties
                                        $ Line = renpy.random.choice([__("You reach out and brush your hands across her panties"), 
                                                __("You grab her panties and pull them taut, elliciting a small gasp"),
                                                __("You put your hand against her mound and grind against it"), 
                                                __("You reach into her gap and she gasps as you slide your hand across and stroke her lips through the thin material"), 
                                                __("Her legs twitch a bit as you press your thumb against her"),
                                                __("She gasps as you reach under her panties and lightly stroke her ass"),
                                                __("You slide a hand up her inner thigh, she moans a little as you reach the point where they meet")])
                            elif GirlA.HoseNum() >= 5: 
                                        #just hose
                                        $ Line = renpy.random.choice([__("You reach out and brush your hands across her cleft through the thin fabric"), 
                                        ...
                                        $ Line = renpy.random.choice([__("You reach out and brush your hands across her bare lips"), 
                                                __("You put your hand against her mound and grind against it"), 
                                                __("You reach into her gap and she gasps as you slide your hand across and stroke her lips"), 
                                                __("Her legs twitch a bit as you press your thumb against her"),
                                                __("She gasps as you reach under her and lightly stroke her ass"),
                                                __("You slide a hand up her inner thigh, she moans a little as you reach the point where they meet")])
                                        if D20S <= 10:
                                            $ TempFocus += 3 if Player.Focus < 50 else 1  
                                            $ TempLust += 4 if GirlA.Lust > 40 else 2
    ...
    # end fondle pussy                               /////////////////////////////////////////////////////////////////////////////
                            ...
                            $ Line = renpy.random.choice([__("You continue to lick ") + GirlA.Name + __("'s pussy. "), 
                                                    __("You continue to suck ") + GirlA.Name + __("'s pussy. "),
                                                    __("You continue to tongue ") + GirlA.Name + __("'s pussy. ")])
                                            
                            if GirlA.PantsNum() > 6 and not GirlA.Upskirt:
                                            $ Line = renpy.random.choice([__("You can feel her twitching as you grind your tongue against her, even through the thick material"),
                                                    __("She gasps as you press on her clit through the thick fabric"),
                                                    __("You rub her clit with your nose as you dive into her pussy with your tongue"),
                                                    __("You put your hand against her mound and lick the surface of her pants"), 
                                                    __("With a little nibble, you tug at the denim"), 
                                                    __("She gasps as you reach under her warm lips and lightly stroke her ass")]) 
                                ...
                                if GirlA.PantsNum() == 5:
                                        if GirlA.Panties == "shorts" and not GirlA.PantiesDown: 
                                                #shorts on
                                                $ Line = renpy.random.choice([__("You push her skirt up and lick at her pussy through her shorts"),                 
                                                        __("You bend down and lick the edges of her lips through the shorts"),                 
                                                        __("You spread the lips back beneath her shorts, and she gasps as you slide your tongue across them"), 
                                                        __("You can feel her twitching as you grind your tongue against her clit"),
                                                        __("She gasps as you suck on her clit through the thin fabric"),
                                                        __("You rub her clit with your thumb as you dive into her pussy with your tongue"),
                                                        __("You put your hand against her mound and lick the juice from her thin shorts"), 
                                                        __("With a little nibble, you tug back the fabric"),
                                                        __("You slowly lick into her gap and she gasps as you press the walls aside"), 
                                                        __("She gasps as you reach under her warm lips and lightly stroke her ass")])
                                        elif GirlA.Panties and not GirlA.PantiesDown:
                                                #Just panties
                                                $ Line = renpy.random.choice([__("You push her skirt up and lick at her pussy through her panties"),                 
                                                        __("You bend down and stroke the edges of her panties with your tongue"),                 
                                                        __("You spread the lips back beneath her panties, and she gasps as you slide your tongue across them"), 
                                                        __("You can feel her twitching as you grind your tongue against her clit"),
                                                        __("She gasps as you suck on her clit through the thin fabric"),
                                                        __("You rub her clit with your thumb as you dive into her pussy with your tongue"),
                                                        __("You put your hand against her mound and lick the juice from her thin panties"), 
                                                        __("With a little nibble, you tug back the fabric"),
                                                        __("You slowly lick into her gap and she gasps as you press the walls aside"), 
                                                        __("She gasps as you reach under her warm lips and lightly stroke her ass")])
                                        elif GirlA.HoseNum() >= 5: 
                                                #just hose
                                               $ Line = renpy.random.choice([__("You push her skirt up and lick at her pussy through her hose"),                 
                                                        __("You bend down and stroke the edges of her lips through the hose"),                 
                                                        __("You spread the lips back beneath her hose, and she gasps as you slide your tongue across them"), 
                                                        __("You can feel her twitching as you grind your tongue against her clit"),
                                                        __("She gasps as you suck on her clit through the thin fabric"),
                                                        __("You rub her clit with your thumb as you dive into her pussy with your tongue"),
                                                        __("You put your hand against her mound and lick the juice from her thin hose"), 
                                                        __("With a little nibble, you tug back the fabric"),
                                                        __("You slowly lick into her gap and she gasps as you press the walls aside"), 
                                                        __("She gasps as you reach under her warm lips and lightly stroke her ass")])
                                        else: #skirt, but nothing else
                                                $ Line = renpy.random.choice([__("You push her skirt aside and stroke her lips with your tongue"), 
                                                        __("You slide your tongue into her pussy and flick the roof with deft strokes"), 
                                                        __("You spread the lips back and she gasps as you slide your tongue between them"), 
                                                        __("You can feel her twitching as you grind your tongue against her clit"),
                                                        __("She gasps as you suck on her clit"),
                                                        __("You rub her clit with your thumb as you dive into her pussy with your tongue"),
                                                        __("You put your hand against her mound and lick around her lips"), 
                                                        __("With a little nibble, you tug on her lower lips"),
                                                        __("You slowly lick into her gap and she gasps as you press the walls aside"), 
                                                        __("She gasps as you reach under her warm lips and lightly stroke her ass")])            
                                                if D20S <= 10:
                                ...
                                #no skirt or pants
                                            ...
                                            # just shorts on
                                            $ Line = renpy.random.choice([__("You bend down and lick the edges of her lips through her shorts"),                 
                                                    __("You spread the lips back beneath her shorts, and she gasps as you slide your tongue across them"), 
                                                    __("You can feel her twitching as you grind your tongue against her clit"),
                                                    __("She gasps as you suck on her clit through the thin fabric"),
                                                    __("You rub her clit with your thumb as you dive into her pussy with your tongue"),
                                            ...
                                            #Just panties
                                            $ Line = renpy.random.choice([__("You bend down and stroke the edges of her panties with your tongue"),                 
                                                    __("You spread the lips back beneath her panties, and she gasps as you slide your tongue across them"), 
                                                    __("You can feel her twitching as you grind your tongue against her clit"),
                                                    __("She gasps as you suck on her clit through the thin fabric"),
                                                    __("You rub her clit with your thumb as you dive into her pussy with your tongue"),
                                            ...
                                            #just hose
                                            $ Line = renpy.random.choice([__("You bend down and stroke her lips with your tongue"),                 
                                                    __("You spread the lips back beneath her hose, and she gasps as you slide your tongue across them"), 
                                                    __("You can feel her twitching as you grind your tongue against her clit"),
                                                    __("She gasps as you suck on her clit through the thin fabric"),
                                                    __("You rub her clit with your thumb as you dive into her pussy with your tongue"),
    ...
    # end lick pussy                               /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ Line = renpy.random.choice([__("You continue to fondle ") + GirlA.Name + __("'s ass. "), 
                                                __("You continue to feel up ") + GirlA.Name + __("'s ass. "),
                                                __("You continue to grope ") + GirlA.Name + __("'s ass. ")])
                                        
                        if GirlA.PantsNum() > 6 and not GirlA.Upskirt:
                                        $ Line = renpy.random.choice([__("You reach out and brush your hands across the back of her pants"), 
                                                __("You slide a hand down her pants, and firmly cup her ass"), 
                                                __("You put your hand against her rear and grind against it"), 
                                                __("You reach into her gap and she gasps as you slide your hand across and stroke her warm mound"), 
                                                __("As you dig your thumb into her, she gasps and raises up a bit"),
                                                __("She gasps as you reach under her and lightly stroke her ass through the pants"),
                                                __("You slide a hand up her inner thigh, she moans a little as it slides betweek her cheeks")])  
                                            
                        elif GirlA.PantsNum() == 5:
                                # skirt
                                if GirlA.Panties == "shorts" and not GirlA.PantiesDown:
                                        #shorts on
                                        $ Line = renpy.random.choice([__("You reach under skirt and brush across her shorts"), 
                                                __("You lift her skirt a bit and grind against her shorts"), 
                                                __("You lift her skirt a bit and she gasps as you pull her shorts aside and stroke across her butt"), 
                                                __("Her legs twitch a bit beneath her skirt as you give her cheeks a firm squeeze"),
                                                __("She gasps as you stroke her asshole through her shorts"),
                                                __("You slide a hand up her inner thigh, she moans a little as it slides betweek her cheeks")])   
                                elif GirlA.Panties and not GirlA.PantiesDown: 
                                        #Just panties
                                        $ Line = renpy.random.choice([__("You reach under skirt and brush across her panties"), 
                                                __("You lift her skirt a bit and grind against her panties"), 
                                                __("You lift her skirt a bit and she gasps as you pull her panties aside and stroke across her butt"), 
                                                __("Her legs twitch a bit beneath her skirt as you give her cheeks a firm squeeze"),
                                                __("She gasps as you stroke her asshole through her panties"),
                                                __("You slide a hand up her inner thigh, she moans a little as it slides betweek her cheeks")])   
                                elif GirlA.HoseNum() >= 5: 
                                        #just hose
                                        $ Line = renpy.random.choice([__("You reach under skirt and brush across her hose"), 
                                                __("You lift her skirt a bit and grind against her hose"), 
                                                __("You lift her skirt a bit and she gasps as you pull her hose aside and stroke across her butt"), 
                                                __("Her legs twitch a bit beneath her skirt as you give her cheeks a firm squeeze"),
                                                __("She gasps as you stroke her asshole through her hose"),
                                                __("You slide a hand up her inner thigh, she moans a little as it slides betweek her cheeks")])   
                                else: #skirt, but nothing else
                                        $ Line = renpy.random.choice([__("You reach under skirt and brush across her bare ass"), 
                                                __("You lift her skirt a bit and grind against her warm cheeks"), 
                                                __("You lift her skirt a bit and she gasps as you stroke asshole"), 
                                                __("Her legs twitch a bit beneath her skirt as you press your thumb against her firm rear"),
                                                __("She gasps as you rub her bare hole"),
                                                __("You slide a hand up her inner thigh, she moans a little as it slides betweek her cheeks")]) 
                                        if D20S <= 10:
                                            $ TempFocus += 2 if Player.Focus < 50 else 1  
                        ...
                        #no skirt or pants
                                    ...
                                    # just shorts on
                                    $ Line = renpy.random.choice([__("You reach out and brush your hands across her lightly covered cheeks"), 
                                            __("You grab her shorts and pull them taut, elliciting a small gasp"),
                                            __("You reach into her gap and she gasps as you slide your hand across and stroke her hole through the thin material"), 
                                            __("Her legs twitch a bit as you grind her puckered hole"),
                                            __("She gasps as you reach under her shorts and lightly stroke her warm flesh"),
                                            __("You slide a hand up her inner thigh, she moans a little as it slides betweek her cheeks")])                                      
                        elif GirlA.Panties and not GirlA.PantiesDown: 
                                    # panties   
                                    $ Line = renpy.random.choice([__("You reach out and brush your hands across her barely covered cheeks"), 
                                            __("You grab her panties and pull them taut, elliciting a small gasp"),
                                            __("You reach into her gap and she gasps as you slide your hand across and stroke her hole through the thin material"), 
                                            __("Her legs twitch a bit as you grind her puckered hole"),
                                            __("She gasps as you reach under her panties and lightly stroke her warm flesh"),
                                            __("You slide a hand up her inner thigh, she moans a little as it slides betweek her cheeks")])  
                        elif GirlA.HoseNum() >= 5: 
                                    #just hose
                                    $ Line = renpy.random.choice([__("You reach out and brush your hands across her barely covered cheeks"), 
                                            ...
                                            __("You reach into her gap and she gasps as you slide your hand across and stroke her hole through the thin material"), 
                                            __("Her legs twitch a bit as you grind her puckered hole"),
                                            __("She gasps as you reach under her hose and lightly stroke her warm flesh"),
                                            __("You slide a hand up her inner thigh, she moans a little as it slides betweek her cheeks")])  
                        else: #nothing
                                    $ Line = renpy.random.choice([__("You reach out and brush your hands across her bare ass"), 
                                            __("You put your hand against her firm rear and grind against it"), 
                                            __("You reach into her gap and she gasps as you slide your hand across and stroke her puckered hole"), 
                                            __("Her legs twitch a bit as you press your thumb against her"),
                                            __("She gasps as you reach under her and lightly stroke her ass"),
                                            __("You slide a hand up her inner thigh, she moans a little as it slides betweek her cheeks")])   
                                    if D20S <= 10:
    ...
    # end fondle ass                               /////////////////////////////////////////////////////////////////////////////
                            ...
                            $ Line = renpy.random.choice([__("You continue to finger ") + GirlA.Name + __("'s asshole. "), 
                                                    __("You continue to finger bang ") + GirlA.Name + __("'s asshole. "),
                                                    __("You continue to finger ") + GirlA.Name + __("'s rim. ")])
                                            
                            if GirlA.PantsNum() > 6 and not GirlA.Upskirt:
                                            $ Line = renpy.random.choice([__("You slide a hand down her pants, and slide your fingers into her anus"), 
                                                    __("You push her panties aside, and slide a finger between her cheeks"), 
                                                    __("You slide a finger into her tight anus"), 
                                                    __("You pull her pants out a bit and she gasps as you slide a finger up her hole"), 
                                                    __("You gasps as you rub her asshole with your fingers")]) 
                            elif GirlA.PantsNum() == 5:
                                    if GirlA.Panties == "shorts" and not GirlA.PantiesDown: 
                                            #shorts on
                                            $ Line = renpy.random.choice([__("You push her skirt and shorts up, and slide a finger into her anus"), 
                                                    __("You slide a finger into her tight anus"), 
                                                    __("You lift her skirt a bit and she gasps as you pull her shorts up and slide a finger into her anus"), 
                                                    __("You rub her pussy with your thumb as you dive into her anus with your middle finger")])
                                    elif GirlA.Panties and not GirlA.PantiesDown: 
                                            #Just panties
                                           $ Line = renpy.random.choice([__("You push her skirt and panties aside, and slide a finger into her anus"), 
                                                    __("You slide a finger into her tight anus"), 
                                                    __("You lift her skirt a bit and she gasps as you pull her panties aside and slide a finger into her anus"), 
                                                    __("You rub her clit with your thumb as you dive into her pussy with your middle finger")])
                                    else: #skirt, but nothing else
                                             $ Line = renpy.random.choice([__("You push her skirt aside, and slide a finger into her anus"), 
                                                    __("You slide a finger into her tight anus"), 
                                                    __("You lift her skirt a bit and she gasps as you slide a finger into her anus"), 
                                                    __("You rub her pussy with your thumb as you dive into her anus with your middle finger")]) 
                            #no skirt or pants
                            elif (GirlA.PantsNum() == 6 or (GirlA == RogueX and GirlA.Panties == "shorts")) and not GirlA.PantiesDown: 
                                    # just shorts on
                                    $ Line = renpy.random.choice([__("You slide a hand down her shorts, and slide a finger into her anus"), 
                                                __("You push her shorts up, and slide a finger between her lips"), 
                                                __("You slide a finger into her tight anus"), 
                                                __("You pull her shorts out a bit and she gasps as you slide a finger into her anus"),                                                 
                                                __("You rub her pussy with your palm as you dive into her anus with your middle finger")])  
                            elif GirlA.Panties and not GirlA.PantiesDown: 
                                        #Just panties
                                        $ Line = renpy.random.choice([__("You push her panties aside, and slide a finger into her anus"), 
                                                __("You slide a finger into her tight anus"), 
                                                __("You lift her panties a bit and she gasps as you and slide a finger into her anus")])
                            else: #nothing
                                        $ Line = renpy.random.choice([__("You reach out and slide a finger into her anus"), 
                                                __("You slide a finger into her tight anus"), 
                                                __("You lift her lips a bit and she gasps as you  slide a finger into her anus"),  
                                                __("You rub her pussy with your thumb as you dive into her anus with your middle finger")]) 
    ...
    # end insert ass                              /////////////////////////////////////////////////////////////////////////////
                            ...
                            $ Line = renpy.random.choice([__("You continue to lick ") + GirlA.Name + __("'s ass. "), 
                                                    __("You continue to suck ") + GirlA.Name + __("'s ass. "),
                                                    __("You continue to tongue ") + GirlA.Name + __("'s ass. ")])
                                            
                            if GirlA.PantsNum() > 6 and not GirlA.Upskirt:
                                                $ Line = renpy.random.choice([__("You can feel her twitching as you grind your tongue against her anus, even through the thick material"),
                                                        __("She gasps as you press on her asshole through the thick fabric"),
                                                        __("You put your hand against her mound and lick the surface of her pants"), 
                                                        __("With a little nibble, you tug at the denim")])  
                                                $ TempFocus += 1 if Player.Focus < 70 else 0  
                                                $ TempLust += 1 if GirlA.Lust < 60 else 0
                                ...
                                if GirlA.PantsNum() == 5:
                                        if GirlA.Panties == "shorts" and not GirlA.PantiesDown:
                                                #shorts on
                                                $ Line = renpy.random.choice([__("You push her skirt up and lick at her asshole through her shorts"),                 
                                                        __("You bend down and stroke the edges of her shorts with your tongue"),                 
                                                        __("You spread the cheeks back beneath her shorts, and she gasps as you slide your tongue into it"), 
                                                        __("You can feel her twitching as you grind your tongue against her anus"),
                                                        __("She gasps as you suck on her asshole through the thin fabric"),
                                                        __("You rub her pussy with your thumb as you dive into her asshole with your tongue"),
                                                        __("With a little nibble, you tug back the fabric"),
                                                        __("You slowly lick into her gap and she gasps as you press the rim aside")])  
                                        elif GirlA.Panties and not GirlA.PantiesDown: 
                                                #Just panties
                                                $ Line = renpy.random.choice([__("You push her skirt up and lick at her asshole through her panties"),                 
                                                        __("You bend down and stroke the edges of her panties with your tongue"),                 
                                                        __("You spread the cheeks back beneath her panties, and she gasps as you slide your tongue into it"), 
                                                        __("You can feel her twitching as you grind your tongue against her anus"),
                                                        __("She gasps as you suck on her asshole through the thin fabric"),
                                                        __("You rub her pussy with your thumb as you dive into her asshole with your tongue"),
                                                        __("With a little nibble, you tug back the fabric"),
                                                ...
                                                #just hose
                                               $ Line = renpy.random.choice([__("You push her skirt up and lick at her asshole through her hose"),                 
                                                        __("You bend down and stroke the edges of her hose with your tongue"),                 
                                                        __("You spread the cheeks back beneath her hose, and she gasps as you slide your tongue into it"), 
                                                        __("You can feel her twitching as you grind your tongue against her anus"),
                                                        __("She gasps as you suck on her asshole through the thin fabric"),
                                                        __("You rub her pussy with your thumb as you dive into her asshole with your tongue"),
                                                        __("With a little nibble, you tug back the fabric"),
                                                ...
                                                $ Line = renpy.random.choice([__("You push her skirt aside and stroke her asshole with your tongue"), 
                                                        __("You spread the cheeks back, and she gasps as you slide your tongue into it"),
                                                        __("You can feel her twitching as you grind your tongue against her asshole"),
                                                        __("She gasps as you suck on her anus"),
                                                        __("You rub her pussy with your thumb as you dive into her asshole with your tongue"),
                                                        __("You put your hand against her mound and lick around her rim"), 
                                                        __("You slowly lick into her gap and she gasps as you press the rim apart")])         
                                                if D20S <= 10:
                                ...
                                #no skirt or pants
                                            ...
                                            # just shorts on
                                            $ Line = renpy.random.choice([__("You bend down and stroke the edges of her shorts with your tongue"),                 
                                                    __("You spread the cheeks back beneath her shorts, and she gasps as you slide your tongue into it"),
                                                    __("You can feel her twitching as you grind your tongue against her anus"),
                                                    __("She gasps as you suck on her anus through the thin fabric"),
                                                    __("You rub her pussy with your thumb as you dive into her anus with your tongue"),
                                                    __("With a little nibble, you tug back the fabric"),
                                                    __("You slowly lick into her gap and she gasps as you press the rim apart")])   
                                elif GirlA.Panties and not GirlA.PantiesDown: 
                                            #Just panties
                                            ...
                                            #just hose
                                            $ Line = renpy.random.choice([__("You bend down and stroke the edges of her hose with your tongue"),                 
                                                    __("You spread the cheeks back beneath her hose, and she gasps as you slide your tongue into it"),
                                                    __("You can feel her twitching as you grind your tongue against her anus"),
                                                    __("She gasps as you suck on her anus through the thin fabric"),
                                                    __("You rub her pussy with your thumb as you dive into her anus with your tongue"),
                                            ...
                                            $ Line = renpy.random.choice([__("You bend down and stroke her rim with your tongue"), 
                                                    __("You slide your tongue into her asshole and flick the roof with deft strokes"), 
                                                    __("You spread the cheeks back, and she gasps as you slide your tongue into it"),
                                                    __("You can feel her twitching as you grind your tongue against her rim"),
                                                    __("She gasps as you suck on her hole"),
                                                    __("You rub her clit with your thumb as you dive into her asshole with your tongue"),
                                                    __("You knead her cheeks and lick around her rim"), 
                                                    __("With a little nibble, you toss her salad"),
                                                    __("You slowly lick into her gap and she gasps as you press the walls aside"), 
                                                    __("She gasps as you reach under her warm lips and lightly stroke her ass")])  
                                            if D20S <= 10: 
                                                $ TempFocus += 2 if Player.Focus < 70 else 0  
    ...
    # end lick ass                               /////////////////////////////////////////////////////////////////////////////
                        ...
                        if GirlA.PantsNum() > 6 and not GirlA.Upskirt:
                                $ Line = renpy.random.choice([__("You rub the dildo against the outside of her pants"), 
                                        __("You slap the dildo lightly against her mound")])
                                $ TempFocus += 1 if Player.Focus < 50 else 0  
                                $ TempLust += 3 if GirlA.Lust < 50 else 1
                        elif GirlA.HoseNum() >= 10:
                                $ Line = renpy.random.choice([__("You rub the dildo against the outside of her tights"), 
                                        __("You slap the dildo lightly at the outside of her tights")])
                                $ TempFocus += 1 if Player.Focus < 50 else 0  
                                $ TempLust += 3 if GirlA.Lust < 50 else 1
                        elif GirlA.HoseNum() >= 5:
                                $ Line = renpy.random.choice([__("You rub the dildo against the outside of her hose"), 
                                        __("You slap the dildo lightly at the outside of her hose")])
                                $ TempFocus += 1 if Player.Focus < 50 else 0  
                                $ TempLust += 3 if GirlA.Lust < 50 else 1
                        else:
                                if GirlA.PantsNum() == 5 and GirlA.Panties:            
                                    $ Line = renpy.random.choice([__("You push her skirt and panties aside, and slide the dildo into her pussy"), 
                                            __("You slide the toy deep into her pussy"), 
                                            __("She gasps as you rotate the dildo within her tight pussy"),
                                            __("You rub her clit with your thumb as you dive into her puss with the rubber phallus")])
                                    $ TempFocus += 2 if Player.Focus < 50 else 1  
                                    $ TempLust += 8 if GirlA.Lust > 70 else 5
                                elif GirlA.PantsNum() == 5:            
                                    $ Line = renpy.random.choice([__("You push her skirt aside, and slide the dildo into her tight hole"), 
                                            __("You slide the toy deep into her pussy"),
                                            __("You lift her skirt a bit and she gasps as you slide the dildo firmly into her tight puss"), 
                                            __("She gasps as you rotate the dildo within her slit"),
                                            __("You rub her clit with your thumb as you dive into her pussy with the rubber phallus")])
                                    $ TempFocus += 2 if Player.Focus < 50 else 1  
                                    $ TempLust += 8 if GirlA.Lust > 70 else 5
                                elif GirlA.Panties and not GirlA.PantiesDown:            
                                    $ Line = renpy.random.choice([__("You push her panties aside, and slide the dildo into her tight pussy"), 
                                            __("You slide the dildo into her moist slit and stroke it rapidly"), 
                                            __("You lift her panties a bit and she gasps as you slide the dildo between her lower lips"), 
                                            __("She gasps as you rub her tight pussy with the toy"),
                                            __("You rub her clit with your thumb as you dive into her pussy with the dildo"),
                                            __("You reach into her gap and she gasps as you slide the dildo in and press against her tight slit through the thin material")])
                                    $ TempFocus += 2 if Player.Focus < 50 else 1  
                                    $ TempLust += 8 if GirlA.Lust > 70 else 5
                                else:            
                                    $ Line = renpy.random.choice([__("You reach out and slide the dildo along her mound"), 
                                            __("You slide the toy into her pussy and stroke it slowly"), 
                                            __("You pull her lips apart and she gasps as you slide the dildo between them"), 
                                            __("You can feel her twitching as you press your thumb against her clit"),
                                            __("She gasps as you rub her clit with the hard rubber"),
                                            __("You rub her clit with your thumb as you dive into her pussy with the dildo"),
                                            __("You reach into her gap and she gasps as you slide the toy across and press it into her wet pussy")])            
                                    $ TempFocus += 3 if Player.Focus < 50 else 1  
    ...
    # end dildo pussy                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if GirlA.PantsNum() > 6 and not GirlA.Upskirt:
                                $ Line = renpy.random.choice([__("You rub the dildo against the outside of her pants"), 
                                        __("You slap the dildo lightly against her ass")])
                                $ TempFocus += 1 if Player.Focus < 50 else 0  
                                $ TempLust += 3 if GirlA.Lust < 50 else 1
                        elif GirlA.HoseNum() >= 10:
                                $ Line = renpy.random.choice([__("You rub the dildo against the outside of her tights"), 
                                ...
                                if GirlA.PantsNum() == 5 and GirlA.Panties:            
                                    $ Line = renpy.random.choice([__("You push her skirt and panties aside, and slide the dildo into her ass"), 
                                            __("You slide the toy deep into her ass"), 
                                            __("She gasps as you rotate the dildo within her tight asshole"),
                                            __("You rub her clit with your thumb as you dive into her ass with the rubber phallus")])
                                    $ TempFocus += 2 if Player.Focus < 50 else 1  
                                    $ TempLust += 8 if GirlA.Lust > 70 else 5
                                elif GirlA.PantsNum() == 5:            
                                    $ Line = renpy.random.choice([__("You push her skirt aside, and slide the dildo into her tight hole"), 
                                            __("You slide the toy deep into her ass"),
                                            __("You lift her skirt a bit and she gasps as you slide the dildo firmly into her tight anus"), 
                                            __("She gasps as you rotate the dildo within her ass"),
                                            __("You rub her clit with your thumb as you dive into her ass with the rubber phallus")])
                                    $ TempFocus += 2 if Player.Focus < 50 else 1  
                                    $ TempLust += 8 if GirlA.Lust > 70 else 5
                                elif GirlA.Panties and not GirlA.PantiesDown:            
                                    $ Line = renpy.random.choice([__("You push her panties aside, and slide the dildo into her tight ass"), 
                                            __("You slide the dildo into her ass and stroke it rapidly"), 
                                            __("You lift her panties a bit and she gasps as you slide the dildo between her cheeks"), 
                                            __("She gasps as you rub her tight asshole with the toy"),
                                            __("You rub her clit with your thumb as you dive into her asshole with the dildo"),
                                            __("You reach into her gap and she gasps as you slide the dildo in and press against her tight anus through the thin material")])
                                    $ TempFocus += 2 if Player.Focus < 50 else 1  
                                    $ TempLust += 8 if GirlA.Lust > 70 else 5
                                else:            
                                    $ Line = renpy.random.choice([__("You reach out and slide the dildo between her cheeks"), 
                                            __("You slide the toy into her asshole and stroke it against the sides"), 
                                            __("You pull her cheeks apart and she gasps as you slide the dildo between them"), 
                                            __("You can feel her twitching as you press your thumb against her anus"),
                                            __("She gasps as you rub her anus with the hard rubber"),
                                            __("You rub her clit with your thumb as you dive into her asshole with the dildo"),
                                            __("You reach into her gap and she gasps as you slide the toy across and press it into her firm anus")])            
                                    $ TempFocus += 3 if Player.Focus < 50 else 1  
...
#                $ TempLust = 0
    ...
    # end Masturbation                               /////////////////////////////////////////////////////////////////////////////
                ...
                call SexDialog_Threeway(GirlA,"lesbian",GirlB=Partner) #Rog*ue_SexDialog_Threeway("lesbian")      
                        ...
                        if GirlA.Foot > 4:                          # After the 5th time 
                                    ...
                                    if Speed <= 1:                      #slow
                                        $ Line = Line + renpy.random.choice([__("She's begining to figure things out, her toes cause tingles as they caress the shaft"), 
                                                __("She's still learning, but learning fast"), 
                                                __("She has a smooth motion going now, gentle and precise"),
                                                __("Her lessons are paying off, she's really becoming very talented at this"),
                                                __("She gently caresses the shaft, and brushes the balls in her other foot, giving them a light massage")])  
                                        ...
                                        $ Line = Line + renpy.random.choice([__("She's begining to figure things out, her toes cause tingles as they caress the shaft"), 
                                                __("She's still learning, but learning fast"), 
                                                __("Her feet glide smoothly across your cock"),
                                                __("She has a smooth motion going now, gentle and precise"),
                                                __("Her lessons are paying off, she's really becoming very talented at this"),
                                                __("She quickly strokes your cock, with a very deft pressure")]) 
                                ...
                                if Speed <= 1:                      #slow
                                    $ Line = Line + renpy.random.choice([__("She makes up for her inexperience with determination, carefully stroking your cock"), 
                                            __("She moves her feet up and down the shaft. She's a little rough at this, but at least she tries"), 
                                            __("She strokes you gently. She isn't quite sure what to do with the balls"),
                                            __("Her toes fumble with your shaft a bit"),
                                            __("She nudges one of your balls too tightly, but stops when you wince"),
                                            __("She has a firm grip, and she's not letting go. This may take a few tries")])     
                                    
                                    $ TempFocus += 10 if Player.Focus > 60 else 5         
                                else:                               #fast 
                                    $ Line = Line + renpy.random.choice([__("She really wasn't prepared for speeding up, and your cock often slips between her feet"), 
                                            __("She rapidly moves her feet up and down the shaft. She's a little rough at this, but at least she tries"), 
                                            __("She strokes you a bit too quickly, the friction is a bit uncomfortable"),
                                            __("Her toes fumble with your shaft a bit"),
                                            __("She nudges one of your balls too tightly, but stops when you wince"),
                                            __("She has a firm grip, and she's not letting go. This train is out of control")])  
    ...
    #End Footy dialog ////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        if GirlA.Kissed > 10 and GirlA.Love >= 700:#Loving
                                $ Line = renpy.random.choice([__("She hungrily presses her lips against yours"), 
                                        __("She confidently presses her lips against yours"), 
                                        __("Her lips part as you hold her close"),    
                                        __("You nibble her neck as she groans in pleasure"),
                                        __("You squeeze her tightly as your tongues jostle"),
                                        __("Her tongue dances around yours"),
                                        __("She nibbles your ear as her hands slide across your back"),
                                        __("Your hands slide down her body as your lips press hers")])
                                $ TempFocus += 1 if Player.Focus < 50 else 0  
                                ...
                                $ Line = renpy.random.choice([__("She confidently presses her lips against yours"), 
                                        __("You softly kiss her plump lips"), 
                                        __("Her lips part as you hold her close"),    
                                        __("You nibble her neck as she coos in pleasure"),
                                        __("You squeeze her tightly as your lips connect"),
                                        __("Her tongue flickers out to meet yours"),
                                        __("Your hands slide down her body as your lips brush hers")])
                                $ TempFocus += 1 if Player.Focus < 70 else 0  
                                $ TempLust += 3 if GirlA.Lust < 50 else 0
                                $ TempLust += 1 if GirlA.Lust < 90 else 0
                        else:#basic kissing
                                $ Line = renpy.random.choice([__("She tentatively presses her lips against yours"), 
                                        __("You softly kiss her plump lips"), 
                                        __("Her lips part slightly as you hold her close"),
                                        __("You squeeze her tightly as your lips connect"),
                                        __("Your hands slide down her body as your lips brush hers")]) 
                                $ TempFocus += 1 if Player.Focus < 70 else 0  
...
label Offhand_Dialog(Girl=Primary, TempLine=0):
    ...
    if Trigger2 == "kiss you":
                $ Line = renpy.random.choice([__(" Your lips gently slide across hers."), 
                        __(" Her lips part as you hold her close."),    
                        __(" You nibble her neck as she groans in pleasure."),
                        __(" You squeeze her tightly as your tongues jostle."),
                        __(" Her tongue dances around yours."),
                        __(" She nibbles your ear as her hands slide across your back."),
                        __(" Your hands slide down her body as your lips press hers."),
                        __(" You kiss her passionately."), 
                        __(" Your tongues swirl around each other's.")])
                if Girl.Love >= 300:
                ...
                if Girl == EmmaX and D20X >= 15:
                    $ Line = __(" You reach out and massage her enormous breasts.")
                    $ PrimaryLust += 1           
                    $ TempFocus += 1 
                elif Girl == KittyX and D20X >= 15:
                    $ Line = __(" You reach out and massage her pert breasts.")
                elif D20X >= 15:
                    $ Line = __(" You reach out and massage her glorious breasts.")
                else:
                    $ Line = renpy.random.choice([__(" You reach out and massage her breasts."), 
                            __(" You pass your hands gently over her warm breasts."), 
                            __(" Her nipples catch lightly on your fingers as you grasp her warm flesh, you can feel them stiffen."),
                            __(" She gasps as you lightly thumb her rigid nipples.")])
                $ PrimaryLust += 3           
            ...
            if Girl.ChestNum() > 1 or Girl.OverNum() > 1:
                $ Line = renpy.random.choice([__(" You bend down and motor-boat her breasts."),
                    __(" You tease her nipples with your tongue through her top."),
                    __(" You slowly lick her nipples through her moist top."), 
                    __(" you gently place a nipple between your lips, and draw it out until it releases with a *pop*."),
                    __(" She gasps as you lightly lick her rigid nipples, poking through her top.")])            
            else:
            ...
            if Girl.Pubes and D20X >= 15:
                $ Line = __(" You draw your hand along her furry bush, dripping with her excitement.")
            elif D20X >= 15:
                $ Line = __(" You draw your hand along her smooth mount, slick with her excitement.")
            else:
                $ Line = renpy.random.choice([__(" You put your hand against her mound and grind against it."), 
                        __(" You reach into her gap and she gasps as you slide your hand across and stroke her lips."), 
                        __(" Her legs twitch a bit as you press your thumb against her."),
                        __(" You slide a singer along her lower lips, and she lets out a small shudder."),
                        __(" You reach between her legs and she gasps as you stroke along her crevice."), 
                        __(" You slide a hand up her inner thigh, she moans a little as you reach the point where they meet.")])
            ...
            if Girl.PantsNum() <= 5 and Girl.PantiesNum() <= 1:                 
                if Girl.Pubes and D20X >= 15:
                    $ Line = __(" You press you nose into her furry bush, dripping with her excitement.")
                elif D20X >= 15:
                    $ Line = __(" You press you nose against her smooth mount, slick with her excitement.")
                else:
                    $ Line = renpy.random.choice([__(" You slide your tongue into her pussy and flick the roof with deft strokes."), 
                        __(" You spread the lips back and she gasps as you slide your tongue between them."), 
                        __(" You can feel her twitching as you grind your tongue against her clit."),
                        __(" She gasps as you suck on her clit."),
                        __(" You rub her clit with your thumb as you dive into her pussy with your tongue."),
                ...
                $ Line = renpy.random.choice([__(" You spread the lips back beneath the thin fabric, and she gasps as you slide your tongue across them."), 
                    __(" She gasps as you suck on her clit through the fabric."),
                    __(" You rub her clit with your thumb as you press against her pussy with your tongue."),
                    __(" You put your hand against her mound and lick the juice that's collected."), 
                    __(" With a little nibble, you tug back the fabric."),
                    __(" You slowly lick into her gap and she gasps as you press the walls aside.")])
            ...
            $ Line = renpy.random.choice([__(" You reach out and brush your hands across her ass."), 
                    __(" You put your hand against her firm rear and grind against it."), 
                    __(" You reach between her legs and she gasps as you stroke along her crevice."), 
                    __(" Her legs twitch a bit as you press your thumb against her."),
                    __(" She gasps as you reach under her and lightly stroke her ass."),
            ...
            $ Line = renpy.random.choice([__(" You reach out and slide a finger into her ass."), 
                    __(" You slide a finger into her asshole and stroke the roof of it."), 
                    __(" You can feel her twitching as you press your thumb against her clit."),
                    __(" She gasps as you rub her asshole with your fingers."),
                    __(" You rub her pussy with your thumb as you dive into her asshole with your middle finger."),
                    __(" You reach into her gap and she gasps as you slide your hand across and press against her hole."), 
                    __(" She gasps as you reach under her warm lips and lightly stroke her ass.")])       
            ...
            if Trigger == "masturbation":
                    $ Line = __(" You stroke your cock as you watch her go.")
            elif Trigger == "lesbian":
                    $ Line = __(" You stroke your cock as you watch them.")
            elif Trigger == "hand":
                    $ Line = renpy.random.choice([__(" You also give it a little rub."), 
                            __(" As she does so, you polish the knob a bit."), 
                            __(" You help."),
                            __(" Your hand bumps into hers occasionally.")])     
            elif Trigger == "blow":
                    if Speed >= 3:
                        $ Line = __(".")
                    else:
                        $ Line = renpy.random.choice([__(" You also give it a little rub."), 
                            __(" As she does so, you work the shaft a bit."), 
                            __(" Your fingers brush her lips."),
                            __(" Her lips brush your hand occasionally.")])    
            else:
                    $ Line = renpy.random.choice([__(" With your other hand, you stroke your shaft."), 
                            __(" You stroke your cock with your other hand."), 
                            __(" As you do, you stoke yourself.")])   
...
label Girl_Self_Lines(GirlA = Primary, Mode = "T3", Action = Trigger3, TempLustX = 0): 
    ...
    if not Action or D20S >= 15: 
            ...
            if not Action: 
                    return
                        ...
                        $ Line = __("Also, " + GirlA.Name + " continues stroke your cock. ")
            elif not Line:        
                        $ Line = __("Also, " + GirlA.Name + " continues to masturbate. ")
    elif Action == "hand": 
                        $ Line = GirlA.Name + " continues stroke your cock. "
    else:        
    ...
    if Action == "hand": 
                        $ Line = Line + renpy.random.choice([__("She lightly strokes the shaft, fingers sliding along the vein"), 
                                __("She grasps the shaft firmly, and slowly slides along its length"), 
                                __("She's becoming something of a handjob expert"),
                                __("Her expert strokes will have you boiling over in seconds"),
                                __("She strokes the shaft vigorously, lightly touching the tip"),
                                __("She moves very smoothly, stroking casually and very gently, like she's been doing this for years"),
                                __("Her hand slides slowly down your shaft")]) 
        ...
        if GirlA.Lust >= 80:   
                if Action == "fondle pussy":
                        $ Line = Line + renpy.random.choice([__("Her hand rapidly moves across her mound, firmly stroking her clit"), 
                                __("She inserts two fingers into her dripping pussy and rapidly pistons them"),
                                __("She gasps as her fingers bury themselves deeply inside her"),
                                __("She gives a little squeal as she pinches her clit between her fingers"),           
                                __("She fingers move quickly across her mound, constantly sliding across her clit"),
                                __("She fingers move rapidly up and down her inner thighs and belly, building towards their center"),
                                __("She spreads her lower lips and furiously strokes the inner lining"),
                                __("She alternately dives her fingers into herself, and licks the juices off of them"),
                                __("She slides two fingers firmly in and out of her tight gap as she massages the clit with her palm"),
                                __("She rapidly circles her fingers against her erect clit"),
                                __("She quickly slides a finger up and down the crease of her pussy"), 
                                __("She lets out a moan as her fingers brush against her erect clit")])
                elif Action == "dildo pussy":
                        $ Line = Line + renpy.random.choice([__("She moves the dildo in circles across her mound, firmly rubbing into it"), 
                                __("She hungrily slams the dildo into her tight pussy, and pistons it in and out"),
                                __("She shoves the dildo firmly in and out of her grasping pussy"),               
                                __("She quickly slides the phallus up and down her crease")])
                elif Action == "fondle ass":
                        $ Line = Line + renpy.random.choice([__("Her hand rapidly moves across her ass, firmly stroking her tight hole"), 
                                __("She inserts a finger deep into her grasping hole and rapidly pistons it"),
                                __("She gasps as she buries a finger deeply into her tight anus"),
                                __("She gives a little squeal as she pinches her clit between her fingers"),           
                                __("Her fingers move quickly across her ass, constantly sliding across her rim"),
                                __("Her fingers move rapidly up and down her inner thighs and ass, building towards their center"),
                                __("She spreads her cheeks and furiously strokes the puckered rim"),
                                __("She slides two fingers firmly in and out of her tight hole"),
                                __("She rapidly circles her fingers against the sensitive rim"),
                                __("She lets out a moan as her fingers brush against her quivering hole")])
                elif Action == "dildo anal":
                        $ Line = Line + renpy.random.choice([__("She moves the dildo in circles across her ass, firmly rubbing into it"), 
                                __("She hungrily slams the dildo into her tight hole, and pistons it in and out"),
                                __("She shoves the dildo firmly in and out of her grasping asshole"),               
                                __("She quickly slides the phallus up and down the crease of her ass")])
                elif Action == "vibrator pussy":
                        $ Line = Line + renpy.random.choice([__("She traces the buzzing ball slowly down her body, barely grazing her mound"),                 
                                __("Her vibrator slides lightly across her pubic region, subtly avoiding her lips"),
                                __("She slides the buzzing egg into her dripping pussy and tugs it in and out"),    
                                __("She presses the vibrator firmly against her clit and a shiver runs through her"),                
                                __("Her whirring toy is dragged up and down her inner thighs, slowly building towards their center"),
                                __("She  spreads her lower lips and runs the device along the inner lining"),
                                __("She presses the toy deep into her and the vibrations send a shock through her body")])
                else: # Action == "fondle breasts"
                        $ Line = Line + renpy.random.choice([__("She passionately rubs her breasts, desperately tugging at her nipples"),
                                __("Her hands squeeze at her breasts, massaging them firmly with both hands"),                 
                                __("She hungrily cups her breasts and moves them in rapid circles"),
                                __("Her hands move constantly across her chest, alternately pulling at her nipples or just grazing her skin"),
                                __("She firmly pinches her nipples and gives them steady tugs"),
                                __("She passionately rubs her breasts, desperately tugging at her nipples")])     
        #End GirlA.Lust >= 80
        elif GirlA.Lust >= 50:   
                if Action == "fondle pussy":
                        $ Line = Line + renpy.random.choice([__("Her hand moves in circles across her mound, firmly rubbing into it"), 
                                __("Her hands move along her sides, carefully caressing them"),                
                                __("Her fingers move smoothly across her delta, occasionally grazing her lips"),
                                __("Her fingers move up and down her inner thighs, slowly building towards their center"),
                                __("She slowly spreads her lower lips and caresses the inner lining"),
                                __("She gently slides a finger up and down the crease of her pussy"), 
                                __("She lets out a gasp as her fingers brush against her erect clit")])
                elif Action == "dildo pussy":
                        $ Line = Line + renpy.random.choice([__("She moves the dildo in circles across her mound, firmly rubbing into it"),  
                                __("She traces the rubber phallus slowly down her body, barely grazing her mound"),  
                                __("Her dildo slides lightly across her pubic region, subtly avoiding her lips"),
                                __("Her dildo is dragged up and down her inner thighs, slowly building towards their center"),
                                __("She slowly spreads her lower lips and caresses the inner lining"),                
                                __("She gently slides the phallus up and down the crease of her pussy"), 
                                __("She drags the dildo slowly along her sides, carefully caressing them")])
                elif Action == "fondle ass":
                        $ Line = Line + renpy.random.choice([__("Her hand moves in circles across her ass, firmly rubbing into it"), 
                                __("Her hands move along her sides, carefully caressing them"),                
                                __("Her fingers move smoothly along her crack, occasionally grazing her asshole"),
                                __("Her fingers move up and down her inner thighs, slowly building towards their center"),
                                __("She slowly spreads her cheeks and caresses the tight hole within"),
                                __("She gently slides a finger up and down the crease of ass"), 
                                __("She lets out a gasp as her fingers brush against her puckered hole")]) 
                elif Action == "dildo anal":
                        $ Line = Line + renpy.random.choice([__("She traces the rubber phallus slowly down her body, barely grazing her ass"),                 
                                __("Her dildo slides lightly across her crack, subtly avoiding the hole"),
                                __("Her dildo is dragged up and down her inner thighs, slowly building towards their center"),
                                __("She slowly spreads her cheeks and caresses the rim beneath"),
                                __("She drags the dildo slowly along her sides, carefully caressing them")])
                elif Action == "vibrator pussy":
                        $ Line = Line + renpy.random.choice([__("She traces the buzzing ball slowly down her body, barely grazing her mound"),                 
                                __("Her vibrator slides lightly across her pubic region, subtly avoiding her lips"),
                                __("Her whirring toy is dragged up and down her inner thighs, slowly building towards their center"),
                                __("She slowly spreads her lower lips and caresses the inner lining"),
                                __("She drags the vibrator slowly along her sides, carefully caressing them")])
                else: # Action == "fondle breasts"
                        $ Line = Line + renpy.random.choice([__("She gently rubs her breasts, dragging a finger across her nipple"),                  
                                __("She gently cups her breasts and moves them in slow circles"),
                                __("She moves her hands from her breasts to rub her neck"),
                                __("She lightly pinches one of her nipples"),
                                __("Her hands firmly caress her breasts, massaging them in circular motions"),
                                __("Her hands move along her breasts, carefully caressing them"),
                                __("She gasps as her finger brushes against an erect nipple")])
        #End GirlA.Lust >= 50
        else: #if GirlA.Lust < 50:      
                if Action == "fondle pussy":
                        $ Line = Line + renpy.random.choice([__("Her hand traces slowly down her body, barely grazing her mound"), 
                                __("Her fingers move lightly across her pubic region, subtly avoiding her lips"),
                                __("Her fingers move up and down her inner thighs, slowly building towards their center"),
                                __("She slowly spreads her lower lips and caresses the inner lining"),
                                __("Her hands move along her sides, carefully caressing them")])  
                elif Action == "dildo pussy":
                        $ Line = Line + renpy.random.choice([__("She traces the rubber phallus slowly down her body, barely grazing her mound"),                 
                                __("Her dildo slides lightly across her pubic region, subtly avoiding her lips"),
                                __("Her dildo is dragged up and down her inner thighs, slowly building towards their center"),
                                __("She slowly spreads her lower lips and caresses the inner lining"),
                                __("She drags the dildo slowly along her sides, carefully caressing them")])
                elif Action == "fondle ass":
                        $ Line = Line + renpy.random.choice([__("Her hand traces slowly down her body, barely passing smoothly across her hips"), 
                                __("Her fingers move lightly across her crack, subtly avoiding her rosebud"),
                                __("Her fingers move up and down her inner thighs, slowly building towards their center"),
                                __("Her hands move along her sides, carefully caressing them")])              
                elif Action == "dildo anal":
                        $ Line = Line + renpy.random.choice([__("She traces the rubber phallus slowly down her body, barely grazing her ass"),                 
...
label SexDialog_Threeway(GirlA = Secondary, Mode = 0, Action = 0, GirlB = Primary, TempLine = 0, TempLust = 0, TempLust2 = 0, TempFocus = 0): #nee Rog*ue_SexDialog_Threeway(Mode = 0, Action = 0, 
    ...
    if Action == "hand":
                    if D20S <= 8 and (Trigger == "blow" or Trigger == "hand"): #This is a random bonus dialog
                        ...
                        $ Line = Line + renpy.random.choice([__(", lightly stroking the shaft, fingers sliding along the vein"), 
                                __(", grasping the shaft firmly, and slowly sliding along its length"), 
                                __(", making up for years of lost time"),
                                __(", her expert strokes will have you boiling over in seconds"),
                                __(", stroking the shaft vigorously, lightly touching the tip"),
                                __(", moving very smoothly, stroking casually"),
                                __(", hand sliding slowly down your shaft")]) 
    ...
    # end GirlA.Hand Threeway                                //////////////////////////////////////////////////////////////////////////////
                    ...
                    if Speed > 2 and Trigger == "blow":
                        $ Line = __("Since " + GirlB.Name + " is working so hard, " + GirlA.Name + " settles for the occasional nibble or lick.")
                        $ TempFocus += 5 if Player.Focus > 60 else 3                      
                        $ TempLust += 2 if GirlA.Lust > 80 else 1    
                    else:
                        if D20S <= 8 and (Trigger == "blow" or Trigger == "hand"): #This is a random bonus dialog
                            ...
                            if Trigger == "blow": #if another girl is also blowing
                                    ...
                                    $ Line = __("Also, " + GirlA.Name + " continues lick your cock")
                            
                            $ Line = Line + renpy.random.choice([__(", settling into a gentle licking pace along the base"),
                                    __(", licking gently up and down the shaft"), 
                                    __(", her tongue moves carefully along the shaft"),
                                    __(", really starting to learn some clever tricks to making you feel good"),
                                    __(", licking her way down the shaft, and gently teasing the balls")]) 
    ...
    # end GirlA.Blowjob Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        $ Line = Line + renpy.random.choice([__(", giving little tugs to her nipples"), 
                                        __(", cupping them firmly with both hands"),                 
                                        __(", gently moving them in slowly increasing circles"),
                                        __(", then moves her hands from her breasts to rub her neck"),
                                        __(", firmly pinching her nipples and giving them a tug"),
                                        __(", passing repeatedly against her rigid nipples")])  
    ...
    # end Fondle breasts Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        $ Line = Line + renpy.random.choice([__(", giving little tugs to her nipple"), 
                                        __(", cupping them firmly with both hands"),               
                                        __(", then moves her hands down along her side"),
                                        __(", licking slowly up her chest"),
                                        __(", firmly nibbling her nipples and giving them a tug"),
                                        __(", nibbling repeatedly at her rigid nipples")])  
                        $ TempLust += 2 if ApprovalCheck(GirlA, 500, "I") else 1  # GirlA's lust
    ...
    # end Suck breasts Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        if (Trigger == "fondle pussy" or Trigger2 == "fondle pussy") and Trigger != "lesbian": #if you're also fondling them,
                                ...
                                $ Templine = renpy.random.choice([__(", stroking across her clit"),   
                                        __(", the two of you taking turns in your motions"),              
                                        __(", her fingers brushing against yours as you work"),
                                        __(", rubbing against it vigorously"),
                                        __(", stroking into it vigorously"),
                                        __(", pressing firmly into it"),
                                        __(", sliding firmly into it"),
                                        __(", moving inside it with slow undulating motions"),
                                        __(", moving with slow undulating motions")])  
                        else:    
                                $ Line = GirlA.Name + " continues to fondle " + GirlB.Name + "'s pussy" 
                                $ Templine = renpy.random.choice([__(", running fingers gently up her cleft"), 
                                        __(", stroking across her clit"),                 
                                        __(", taking a little taste of the warm juices on her finger"),
                                        __(", rubbing against it vigorously"),
                                        __("a"),
                                        __("b"),
                                        __("c"),
    ...
    # end fondle pussy Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ Templine = renpy.random.choice([__(", running her tongue gently up her cleft"), 
                                    __(", stroking across her clit"),                 
                                    __(", taking a little taste of the warm juices flowing out"),
                                    __(", lapping against it vigorously"),
                                    __("a"),
                                    __("b"),
                                    __("c"),
                                    __(", moving with slow undulating motions")])  
    ...
    # end lick pussy Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if Trigger2 == "fondle ass" and Trigger != "lesbian": #if you're also fondling them,
                                ...
                                $ Line = Line + renpy.random.choice([__(", stroking across her rear"),   
                                        __(", the two of you taking turns in your motions"),              
                                        __(", her fingers brushing against yours as you work"),
                                        __(", rubbing it vigorously"),
                                        __(", squeezing it vigorously"),
                                        __(", pressing firmly into it"),
                                        __(", kneeding it with slow undulating motions"),
                                        __(", moving with slow undulating motions")])  
                        else:
                                $ Line = GirlA.Name + " continues to fondle " + GirlB.Name + "'s ass" 
                                $ Line = Line + renpy.random.choice([__(", running fingers gently up her cleft"), 
                                        __(", stroking across her rear"),                 
                                        __(", rubbing it vigorously"),
                                        __(", squeezing it vigorously"),
                                        __(", pressing firmly into it"),
                                        __(", kneeding it with slow undulating motions"),
    ...
    # end fondle ass Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ Templine = renpy.random.choice([__(", stroking across her rim"),  
                                    __(", stroking across her hole"),                 
                                    __(", circling it vigorously"),
                                    __("a"),
                                    __("b"),
                                    __("c"),
                                    __(", moving with slow undulating motions")])  
    ...
    # end insert ass Threeway                             /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ Templine = renpy.random.choice([__(", tonguing across her rim"), 
                                    __(", stroking across her hole"),
                                    __(", circling it vigorously"),
                                    __("a"),
                                    __("b"),
    ...
    # end Masturbation Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if Trigger == "blow" and GirlA.Blow > 5 and Trigger4 == "kiss girl":
                                    ...
                                    $ Line = Line + renpy.random.choice([__(", occasionally taking a lick of your cock as well"), 
                                            __(", licking along her cheek"),
                                            __(", nudging you out of her mouth to get a deep kiss in"),
                                            __(", taking the occasional lick down your shaft"),
                                            __(", nudging her aside to kiss the head of your cock")])
                        elif Trigger == "blow" and Trigger4 == "kiss girl":
                                    $ Line = GirlA.Name + " also continues to kiss " + GirlB.Name
                                    $ Line = Line + renpy.random.choice([__(", occasionally bumping into your cock as well"), 
                                            __(", licking along her cheek"),
                                            __(", nudging you out of her mouth to get a deep kiss in"),
                                            __(", trailing kisses down her neck")])
                                    ...
                                    if Action == "kiss girl" or Mode == "lesbian":
                                        ...
                                        $ Line = Line + renpy.random.choice([__(", occasionally coming up for air"), 
                                                __(", licking along her cheek"),
                                                __(", grabbing her face in both hands"),
                                                __(", their tongues swirl around each other"),
                                                __(", occasionally nibbling at her ears"),
                                                __(", trailing kisses down her neck")])
                                    elif Action == "kiss you":
                                        $ Line = GirlA.Name + " also continues to make out with you" 
                                        $ Line = Line + renpy.random.choice([__(", occasionally coming up for air"), 
                                                __(", licking along your cheek"),
                                                __(", grabbing your face in both hands"),
                                                __(", your tongues swirl around each other"),
                                                __(", occasionally nibbling at your ears"),
                                                __(", trailing kisses down your neck")])
                                    else: #Action == "kiss both":
                                        $ Line = GirlA.Name + " also continues to make out with both of you"
                                        $ Line = Line + renpy.random.choice([__(", occasionally coming up for air"), 
                                                __(", licking along your cheek"),
                                                __(", occasionally nibbling your lip as well"), 
                                                __(", nudging you aside to get a deep kiss in"),
                                                __(", all three of your tongues swirling"),
                                                __(", nudging her aside to give you a deep kiss"),
                                                __(", grabbing your face in both hands"),
                                                __(", your tongues swirl around each other"),
                                                __(", licking along her cheek"),
                                                __(", grabbing her face in both hands"),
    ...
    # end Kissing Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ Line = Line + renpy.random.choice([__(", shifting uncomfortably"), 
                                        __(", readjusting her clothes"),                 
                                        __(", glancing at the door"),               
                                        __(", taking in ") + GirlB.Name + __("'s body"),
                                        __(", transfixed by the action")]) 
